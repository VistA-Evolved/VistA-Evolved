ZVEAN ;VE/AUTO - Anesthesiology Custom RPCs (Auto-generated);2026-03-10
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Anesthesiology (AN)
 ; Provides custom RPCs wrapping FileMan APIs for package AN.
 ;
 ; Entry points:
 ;   INSTALL^ZVEAN  - Register RPCs in File #8994
 ;   VERIFY^ZVEAN   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Anesthesiology RPCs ==="
