ZVEPSX ;VE/AUTO - CMOP Custom RPCs (Auto-generated);2026-03-10
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for CMOP (PSX)
 ; Provides custom RPCs wrapping FileMan APIs for package PSX.
 ;
 ; Entry points:
 ;   INSTALL^ZVEPSX  - Register RPCs in File #8994
 ;   VERIFY^ZVEPSX   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing CMOP RPCs ==="
