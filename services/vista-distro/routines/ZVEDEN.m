ZVEDEN ;VE/AUTO - Dental Custom RPCs (Auto-generated);2026-03-10
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Dental (DEN)
 ; Provides custom RPCs wrapping FileMan APIs for package DEN.
 ;
 ; Entry points:
 ;   INSTALL^ZVEDEN  - Register RPCs in File #8994
 ;   VERIFY^ZVEDEN   - Verify registration
 ;
 Q
 ;
...
VERIFY ; Verify registration
 ...
 . I $E(NAME,1,6)="VE DEN" D
 . . S CNT=CNT+1
 . . W !,"  "_NAME
 W !,"Total VE DEN RPCs: "_CNT
 Q
 ;