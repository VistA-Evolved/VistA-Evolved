ZVEFH ;VE/AUTO - Dietetics Custom RPCs (Auto-generated);2026-03-10
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Dietetics (FH)
 ; Provides custom RPCs wrapping FileMan APIs for package FH.
 ;
 ; Entry points:
 ;   INSTALL^ZVEFH  - Register RPCs in File #8994
 ;   VERIFY^ZVEFH   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Dietetics RPCs ==="
