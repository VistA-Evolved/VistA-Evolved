ZVEONC ;VE/AUTO - Oncology Custom RPCs (Auto-generated);2026-03-10
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Oncology (ONC)
 ; Provides custom RPCs wrapping FileMan APIs for package ONC.
 ;
 ; Entry points:
 ;   INSTALL^ZVEONC  - Register RPCs in File #8994
 ;   VERIFY^ZVEONC   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Oncology RPCs ==="
