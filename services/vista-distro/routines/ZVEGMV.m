ZVEGMV ;VE/AUTO - Vitals Custom RPCs (Auto-generated);2026-03-10
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Vitals (GMV)
 ; Provides custom RPCs wrapping FileMan APIs for package GMV.
 ;
 ; Entry points:
 ;   INSTALL^ZVEGMV  - Register RPCs in File #8994
 ;   VERIFY^ZVEGMV   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Vitals RPCs ==="
