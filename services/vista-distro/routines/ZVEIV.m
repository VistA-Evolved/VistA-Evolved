ZVEIV ;VE/AUTO - IV Pharmacy Custom RPCs (Auto-generated);2026-03-10
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for IV Pharmacy (IV)
 ; Provides custom RPCs wrapping FileMan APIs for package IV.
 ;
 ; Entry points:
 ;   INSTALL^ZVEIV  - Register RPCs in File #8994
 ;   VERIFY^ZVEIV   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing IV Pharmacy RPCs ==="
