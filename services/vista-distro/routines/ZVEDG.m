ZVEDG ;VE/AUTO - Registration Custom RPCs (Auto-generated);2026-03-10
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Registration (DG)
 ; Provides custom RPCs wrapping FileMan APIs for package DG.
 ;
 ; Entry points:
 ;   INSTALL^ZVEDG  - Register RPCs in File #8994
 ;   VERIFY^ZVEDG   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Registration RPCs ==="
