ZVEXU ;VE/AUTO - Kernel Custom RPCs (Auto-generated);2026-03-10
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Kernel (XU)
 ; Provides custom RPCs wrapping FileMan APIs for package XU.
 ;
 ; Entry points:
 ;   INSTALL^ZVEXU  - Register RPCs in File #8994
 ;   VERIFY^ZVEXU   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Kernel RPCs ==="
