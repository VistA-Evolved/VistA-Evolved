ZVEVDEF ;VE/AUTO - VDEF Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for VDEF (VDEF)
 ; Provides custom RPCs wrapping FileMan APIs for package VDEF.
 ;
 ; Entry points:
 ;   INSTALL^ZVEVDEF  - Register RPCs in File #8994
 ;   VERIFY^ZVEVDEF   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing VDEF RPCs ==="
