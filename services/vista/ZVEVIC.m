ZVEVIC ;VE/AUTO - VIC Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for VIC (VIC)
 ; Provides custom RPCs wrapping FileMan APIs for package VIC.
 ;
 ; Entry points:
 ;   INSTALL^ZVEVIC  - Register RPCs in File #8994
 ;   VERIFY^ZVEVIC   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing VIC RPCs ==="
