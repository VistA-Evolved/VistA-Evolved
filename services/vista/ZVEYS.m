ZVEYS ;VE/AUTO - Mental Health Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Mental Health (YS)
 ; Provides custom RPCs wrapping FileMan APIs for package YS.
 ;
 ; Entry points:
 ;   INSTALL^ZVEYS  - Register RPCs in File #8994
 ;   VERIFY^ZVEYS   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Mental Health RPCs ==="
