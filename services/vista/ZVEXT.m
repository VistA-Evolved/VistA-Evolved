ZVEXT ;VE/AUTO - Toolkit Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Toolkit (XT)
 ; Provides custom RPCs wrapping FileMan APIs for package XT.
 ;
 ; Entry points:
 ;   INSTALL^ZVEXT  - Register RPCs in File #8994
 ;   VERIFY^ZVEXT   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Toolkit RPCs ==="
