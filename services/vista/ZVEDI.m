ZVEDI ;VE/AUTO - VA FileMan Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for VA FileMan (DI)
 ; Provides custom RPCs wrapping FileMan APIs for package DI.
 ;
 ; Entry points:
 ;   INSTALL^ZVEDI  - Register RPCs in File #8994
 ;   VERIFY^ZVEDI   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing VA FileMan RPCs ==="
