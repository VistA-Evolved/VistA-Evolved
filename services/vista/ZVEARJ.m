ZVEARJ ;VE/AUTO - ARJ Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for ARJ (ARJ)
 ; Provides custom RPCs wrapping FileMan APIs for package ARJ.
 ;
 ; Entry points:
 ;   INSTALL^ZVEARJ  - Register RPCs in File #8994
 ;   VERIFY^ZVEARJ   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing ARJ RPCs ==="
