ZVEIBCN ;VE/AUTO - IBCN Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for IBCN (IBCN)
 ; Provides custom RPCs wrapping FileMan APIs for package IBCN.
 ;
 ; Entry points:
 ;   INSTALL^ZVEIBCN  - Register RPCs in File #8994
 ;   VERIFY^ZVEIBCN   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing IBCN RPCs ==="
