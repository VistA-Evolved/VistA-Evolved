ZVEDPT ;VE/AUTO - DPT Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for DPT (DPT)
 ; Provides custom RPCs wrapping FileMan APIs for package DPT.
 ;
 ; Entry points:
 ;   INSTALL^ZVEDPT  - Register RPCs in File #8994
 ;   VERIFY^ZVEDPT   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing DPT RPCs ==="
