ZVELR ;VE/AUTO - Lab Service Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Lab Service (LR)
 ; Provides custom RPCs wrapping FileMan APIs for package LR.
 ;
 ; Entry points:
 ;   INSTALL^ZVELR  - Register RPCs in File #8994
 ;   VERIFY^ZVELR   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Lab Service RPCs ==="
