ZVEXOB ;VE/AUTO - XOB Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for XOB (XOB)
 ; Provides custom RPCs wrapping FileMan APIs for package XOB.
 ;
 ; Entry points:
 ;   INSTALL^ZVEXOB  - Register RPCs in File #8994
 ;   VERIFY^ZVEXOB   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing XOB RPCs ==="
