ZVEOOPS ;VE/AUTO - Asists Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Asists (OOPS)
 ; Provides custom RPCs wrapping FileMan APIs for package OOPS.
 ;
 ; Entry points:
 ;   INSTALL^ZVEOOPS  - Register RPCs in File #8994
 ;   VERIFY^ZVEOOPS   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Asists RPCs ==="
