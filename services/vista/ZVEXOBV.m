ZVEXOBV ;VE/AUTO - VistALink Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for VistALink (XOBV)
 ; Provides custom RPCs wrapping FileMan APIs for package XOBV.
 ;
 ; Entry points:
 ;   INSTALL^ZVEXOBV  - Register RPCs in File #8994
 ;   VERIFY^ZVEXOBV   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing VistALink RPCs ==="
