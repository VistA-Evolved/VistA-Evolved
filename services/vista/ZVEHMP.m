ZVEHMP ;VE/AUTO - HMP Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for HMP (HMP)
 ; Provides custom RPCs wrapping FileMan APIs for package HMP.
 ;
 ; Entry points:
 ;   INSTALL^ZVEHMP  - Register RPCs in File #8994
 ;   VERIFY^ZVEHMP   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing HMP RPCs ==="
