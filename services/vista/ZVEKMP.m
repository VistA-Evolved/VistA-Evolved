ZVEKMP ;VE/AUTO - KMP Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for KMP (KMP)
 ; Provides custom RPCs wrapping FileMan APIs for package KMP.
 ;
 ; Entry points:
 ;   INSTALL^ZVEKMP  - Register RPCs in File #8994
 ;   VERIFY^ZVEKMP   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing KMP RPCs ==="
