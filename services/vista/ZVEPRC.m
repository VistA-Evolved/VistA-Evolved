ZVEPRC ;VE/AUTO - IFCAP Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for IFCAP (PRC)
 ; Provides custom RPCs wrapping FileMan APIs for package PRC.
 ;
 ; Entry points:
 ;   INSTALL^ZVEPRC  - Register RPCs in File #8994
 ;   VERIFY^ZVEPRC   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing IFCAP RPCs ==="
