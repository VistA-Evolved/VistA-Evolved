ZVEDENT ;VE/AUTO - Dental Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Dental (DENT)
 ; Provides custom RPCs wrapping FileMan APIs for package DENT.
 ;
 ; Entry points:
 ;   INSTALL^ZVEDENT  - Register RPCs in File #8994
 ;   VERIFY^ZVEDENT   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Dental RPCs ==="
