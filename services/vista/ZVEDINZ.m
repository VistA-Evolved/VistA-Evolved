ZVEDINZ ;VE/AUTO - DINZ Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for DINZ (DINZ)
 ; Provides custom RPCs wrapping FileMan APIs for package DINZ.
 ;
 ; Entry points:
 ;   INSTALL^ZVEDINZ  - Register RPCs in File #8994
 ;   VERIFY^ZVEDINZ   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing DINZ RPCs ==="
