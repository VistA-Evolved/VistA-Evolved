ZVEXUS ;VE/AUTO - XUS Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for XUS (XUS)
 ; Provides custom RPCs wrapping FileMan APIs for package XUS.
 ;
 ; Entry points:
 ;   INSTALL^ZVEXUS  - Register RPCs in File #8994
 ;   VERIFY^ZVEXUS   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing XUS RPCs ==="
