ZVEMAG ;VE/AUTO - Imaging Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Imaging (MAG)
 ; Provides custom RPCs wrapping FileMan APIs for package MAG.
 ;
 ; Entry points:
 ;   INSTALL^ZVEMAG  - Register RPCs in File #8994
 ;   VERIFY^ZVEMAG   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Imaging RPCs ==="
