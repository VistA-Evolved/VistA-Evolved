ZVEPRS ;VE/AUTO - PAID Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for PAID (PRS)
 ; Provides custom RPCs wrapping FileMan APIs for package PRS.
 ;
 ; Entry points:
 ;   INSTALL^ZVEPRS  - Register RPCs in File #8994
 ;   VERIFY^ZVEPRS   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing PAID RPCs ==="
