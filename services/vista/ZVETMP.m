ZVETMP ;VE/AUTO - TMP Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for TMP (TMP)
 ; Provides custom RPCs wrapping FileMan APIs for package TMP.
 ;
 ; Entry points:
 ;   INSTALL^ZVETMP  - Register RPCs in File #8994
 ;   VERIFY^ZVETMP   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing TMP RPCs ==="
