ZVEMCAR ;VE/AUTO - MCAR Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for MCAR (MCAR)
 ; Provides custom RPCs wrapping FileMan APIs for package MCAR.
 ;
 ; Entry points:
 ;   INSTALL^ZVEMCAR  - Register RPCs in File #8994
 ;   VERIFY^ZVEMCAR   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing MCAR RPCs ==="
