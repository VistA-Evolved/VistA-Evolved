ZVEVEEM ;VE/AUTO - VPE Shell Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for VPE Shell (VEEM)
 ; Provides custom RPCs wrapping FileMan APIs for package VEEM.
 ;
 ; Entry points:
 ;   INSTALL^ZVEVEEM  - Register RPCs in File #8994
 ;   VERIFY^ZVEVEEM   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing VPE Shell RPCs ==="
