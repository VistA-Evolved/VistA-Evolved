ZVEEN ;VE/AUTO - Engineering Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Engineering (EN)
 ; Provides custom RPCs wrapping FileMan APIs for package EN.
 ;
 ; Entry points:
 ;   INSTALL^ZVEEN  - Register RPCs in File #8994
 ;   VERIFY^ZVEEN   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Engineering RPCs ==="
