ZVEVFD ;VE/AUTO - VFD Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for VFD (VFD)
 ; Provides custom RPCs wrapping FileMan APIs for package VFD.
 ;
 ; Entry points:
 ;   INSTALL^ZVEVFD  - Register RPCs in File #8994
 ;   VERIFY^ZVEVFD   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing VFD RPCs ==="
