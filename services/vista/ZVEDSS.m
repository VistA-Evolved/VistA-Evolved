ZVEDSS ;VE/AUTO - DSS Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for DSS (DSS)
 ; Provides custom RPCs wrapping FileMan APIs for package DSS.
 ;
 ; Entry points:
 ;   INSTALL^ZVEDSS  - Register RPCs in File #8994
 ;   VERIFY^ZVEDSS   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing DSS RPCs ==="
