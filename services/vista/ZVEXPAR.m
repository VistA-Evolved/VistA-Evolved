ZVEXPAR ;VE/AUTO - XPAR Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for XPAR (XPAR)
 ; Provides custom RPCs wrapping FileMan APIs for package XPAR.
 ;
 ; Entry points:
 ;   INSTALL^ZVEXPAR  - Register RPCs in File #8994
 ;   VERIFY^ZVEXPAR   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing XPAR RPCs ==="
