ZVEFB ;VE/AUTO - Fee Basis Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Fee Basis (FB)
 ; Provides custom RPCs wrapping FileMan APIs for package FB.
 ;
 ; Entry points:
 ;   INSTALL^ZVEFB  - Register RPCs in File #8994
 ;   VERIFY^ZVEFB   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Fee Basis RPCs ==="
