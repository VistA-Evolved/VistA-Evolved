ZVEICD ;VE/AUTO - DRG Grouper Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for DRG Grouper (ICD)
 ; Provides custom RPCs wrapping FileMan APIs for package ICD.
 ;
 ; Entry points:
 ;   INSTALL^ZVEICD  - Register RPCs in File #8994
 ;   VERIFY^ZVEICD   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing DRG Grouper RPCs ==="
