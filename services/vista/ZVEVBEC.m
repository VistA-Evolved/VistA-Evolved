ZVEVBEC ;VE/AUTO - VBECS Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for VBECS (VBEC)
 ; Provides custom RPCs wrapping FileMan APIs for package VBEC.
 ;
 ; Entry points:
 ;   INSTALL^ZVEVBEC  - Register RPCs in File #8994
 ;   VERIFY^ZVEVBEC   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing VBECS RPCs ==="
