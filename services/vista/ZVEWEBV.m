ZVEWEBV ;VE/AUTO - VistA Web Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for VistA Web (WEBV)
 ; Provides custom RPCs wrapping FileMan APIs for package WEBV.
 ;
 ; Entry points:
 ;   INSTALL^ZVEWEBV  - Register RPCs in File #8994
 ;   VERIFY^ZVEWEBV   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing VistA Web RPCs ==="
