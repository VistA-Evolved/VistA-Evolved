ZVEMC ;VE/AUTO - Medicine Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Medicine (MC)
 ; Provides custom RPCs wrapping FileMan APIs for package MC.
 ;
 ; Entry points:
 ;   INSTALL^ZVEMC  - Register RPCs in File #8994
 ;   VERIFY^ZVEMC   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Medicine RPCs ==="
