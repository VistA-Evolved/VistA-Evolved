ZVEXWB ;VE/AUTO - RPC Broker Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for RPC Broker (XWB)
 ; Provides custom RPCs wrapping FileMan APIs for package XWB.
 ;
 ; Entry points:
 ;   INSTALL^ZVEXWB  - Register RPCs in File #8994
 ;   VERIFY^ZVEXWB   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing RPC Broker RPCs ==="
