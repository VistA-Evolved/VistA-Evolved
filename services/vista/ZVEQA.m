ZVEQA ;VE/AUTO - QA Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for QA (QA)
 ; Provides custom RPCs wrapping FileMan APIs for package QA.
 ;
 ; Entry points:
 ;   INSTALL^ZVEQA  - Register RPCs in File #8994
 ;   VERIFY^ZVEQA   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing QA RPCs ==="
