ZVEIC ;VE/AUTO - IC Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for IC (IC)
 ; Provides custom RPCs wrapping FileMan APIs for package IC.
 ;
 ; Entry points:
 ;   INSTALL^ZVEIC  - Register RPCs in File #8994
 ;   VERIFY^ZVEIC   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing IC RPCs ==="
