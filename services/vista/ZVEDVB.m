ZVEDVB ;VE/AUTO - HINQ Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for HINQ (DVB)
 ; Provides custom RPCs wrapping FileMan APIs for package DVB.
 ;
 ; Entry points:
 ;   INSTALL^ZVEDVB  - Register RPCs in File #8994
 ;   VERIFY^ZVEDVB   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing HINQ RPCs ==="
