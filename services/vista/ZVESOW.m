ZVESOW ;VE/AUTO - Social Work Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Social Work (SOW)
 ; Provides custom RPCs wrapping FileMan APIs for package SOW.
 ;
 ; Entry points:
 ;   INSTALL^ZVESOW  - Register RPCs in File #8994
 ;   VERIFY^ZVESOW   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Social Work RPCs ==="
