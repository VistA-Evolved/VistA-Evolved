ZVESD ;VE/AUTO - Scheduling Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Scheduling (SD)
 ; Provides custom RPCs wrapping FileMan APIs for package SD.
 ;
 ; Entry points:
 ;   INSTALL^ZVESD  - Register RPCs in File #8994
 ;   VERIFY^ZVESD   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Scheduling RPCs ==="
