ZVELBR ;VE/AUTO - Library Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Library (LBR)
 ; Provides custom RPCs wrapping FileMan APIs for package LBR.
 ;
 ; Entry points:
 ;   INSTALL^ZVELBR  - Register RPCs in File #8994
 ;   VERIFY^ZVELBR   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Library RPCs ==="
