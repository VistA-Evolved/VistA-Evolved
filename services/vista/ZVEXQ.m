ZVEXQ ;VE/AUTO - XQ Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for XQ (XQ)
 ; Provides custom RPCs wrapping FileMan APIs for package XQ.
 ;
 ; Entry points:
 ;   INSTALL^ZVEXQ  - Register RPCs in File #8994
 ;   VERIFY^ZVEXQ   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing XQ RPCs ==="
