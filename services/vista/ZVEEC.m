ZVEEC ;VE/AUTO - Event Capture Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Event Capture (EC)
 ; Provides custom RPCs wrapping FileMan APIs for package EC.
 ;
 ; Entry points:
 ;   INSTALL^ZVEEC  - Register RPCs in File #8994
 ;   VERIFY^ZVEEC   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Event Capture RPCs ==="
