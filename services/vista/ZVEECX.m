ZVEECX ;VE/AUTO - DSS Extracts Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for DSS Extracts (ECX)
 ; Provides custom RPCs wrapping FileMan APIs for package ECX.
 ;
 ; Entry points:
 ;   INSTALL^ZVEECX  - Register RPCs in File #8994
 ;   VERIFY^ZVEECX   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing DSS Extracts RPCs ==="
