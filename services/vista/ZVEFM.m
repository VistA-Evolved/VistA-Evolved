ZVEFM ;VE/AUTO - FM Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for FM (FM)
 ; Provides custom RPCs wrapping FileMan APIs for package FM.
 ;
 ; Entry points:
 ;   INSTALL^ZVEFM  - Register RPCs in File #8994
 ;   VERIFY^ZVEFM   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing FM RPCs ==="
