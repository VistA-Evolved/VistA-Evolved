ZVEACKQ ;VE/AUTO - Quasar Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for Quasar (ACKQ)
 ; Provides custom RPCs wrapping FileMan APIs for package ACKQ.
 ;
 ; Entry points:
 ;   INSTALL^ZVEACKQ  - Register RPCs in File #8994
 ;   VERIFY^ZVEACKQ   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing Quasar RPCs ==="
