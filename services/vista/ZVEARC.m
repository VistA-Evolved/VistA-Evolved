ZVEARC ;VE/AUTO - ARC Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for ARC (ARC)
 ; Provides custom RPCs wrapping FileMan APIs for package ARC.
 ;
 ; Entry points:
 ;   INSTALL^ZVEARC  - Register RPCs in File #8994
 ;   VERIFY^ZVEARC   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing ARC RPCs ==="
