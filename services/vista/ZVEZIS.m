ZVEZIS ;VE/AUTO - ZIS Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for ZIS (ZIS)
 ; Provides custom RPCs wrapping FileMan APIs for package ZIS.
 ;
 ; Entry points:
 ;   INSTALL^ZVEZIS  - Register RPCs in File #8994
 ;   VERIFY^ZVEZIS   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing ZIS RPCs ==="
