ZVEXHD ;VE/AUTO - XHD Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for XHD (XHD)
 ; Provides custom RPCs wrapping FileMan APIs for package XHD.
 ;
 ; Entry points:
 ;   INSTALL^ZVEXHD  - Register RPCs in File #8994
 ;   VERIFY^ZVEXHD   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing XHD RPCs ==="
