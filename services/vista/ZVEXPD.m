ZVEXPD ;VE/AUTO - XPD Custom RPCs (Auto-generated);2026-03-11
 ;;1.0;VistA-Evolved;**AUTO**;;
 ;
 ; Auto-generated by vista-module-gen for XPD (XPD)
 ; Provides custom RPCs wrapping FileMan APIs for package XPD.
 ;
 ; Entry points:
 ;   INSTALL^ZVEXPD  - Register RPCs in File #8994
 ;   VERIFY^ZVEXPD   - Verify registration
 ;
 Q
 ;
INSTALL ; Register custom RPCs
 W !,"=== Installing XPD RPCs ==="
