...
const DOMAIN_PATTERNS = [
  ...
  {
    domain: 'portal',
    patterns: [/\/portal\//, /portal/i, /patient.?self/i, /consent/i, /document/i],
  },
  { domain: 'imaging', patterns: [/\/imaging\//, /dicom/i, /orthanc/i, /ohif/i, /worklist/i] },
  {
    domain: 'rcm',
    patterns: [/\/rcm\//, /claim/i, /payer/i, /billing/i, /edi/i, /remit/i, /denial/i],
  },
  { domain: 'telehealth', patterns: [/\/telehealth\//, /jitsi/i, /room.*video/i] },
  {
    domain: 'iam',
    patterns: [/\/iam\//, /\/auth\//, /oidc/i, /passkey/i, /policy.*engine/i, /break.?glass/i],
  },
  ...
  {
    domain: 'scheduling',
    patterns: [/\/scheduling\//, /appointment/i, /clinic.*pref/i, /check.?in/i],
  },
  { domain: 'interop', patterns: [/\/interop\//, /hl7/i, /hlo/i, /fhir/i] },
  {
    domain: 'observability',
    patterns: [/\/posture\//, /\/metrics\//, /otel/i, /prometheus/i, /jaeger/i],
  },
  {
    domain: 'modules',
    patterns: [/\/modules\//, /\/capabilities\//, /\/adapters\//, /sku/i, /module.*guard/i],
  },
];
...
const RPC_WORKFLOWS = {
  login: {
    rpcs: ['XUS SIGNON SETUP', 'XUS AV CODE', 'XWB CREATE CONTEXT', 'XUS GET USER INFO'],
    domain: 'iam',
  },
