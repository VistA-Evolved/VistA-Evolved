<#
.SYNOPSIS
    VistA-Evolved Phase 1-4B Verification Script
.DESCRIPTION
    Verifies phases from Hello System through Phase 4B Patient Search.
    Run from repo root: .\scripts\verify-phase1-to-phase4b.ps1
.NOTES
...
Write-Host ""
Write-Host "VistA-Evolved Phase 1-4B Verification" -ForegroundColor White -BackgroundColor DarkBlue
