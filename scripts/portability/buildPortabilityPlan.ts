  ...
  sections: [
    {
      ...
      rpcUsed: [
        { rpc: "ORQQAL LIST", purpose: "List patient allergies", status: "available" },
      ],
      pendingTargets: [],
    ...
    },
    {
      ...
      rpcUsed: [
        { rpc: "ORWPS ACTIVE", purpose: "Active medication list", status: "available" },
      ],
      pendingTargets: [],
      exportFormats: ["pdf", "html", "json"],
    },
    {
      ...
      rpcUsed: [
        { rpc: "ORQQPL LIST", purpose: "Problem list", status: "available" },
      ],
      pendingTargets: [],
      exportFormats: ["pdf", "html", "json"],
    },
    ...
    },
    {
      ...
      rpcUsed: [
        { rpc: "ORWLRR INTERIMG", purpose: "Interim lab results", status: "available" },
      ],
      pendingTargets: [
        {
          rpc: "ORWLRR CHART",
    ...
    },
    {
      ...
      rpcUsed: [
        { rpc: "ORWPT ID INFO", purpose: "Patient identifiers", status: "available" },
      ],
      pendingTargets: [],
      exportFormats: ["pdf", "html", "json"],
    },
...
const pendingRpcs = plan.sections.reduce(
  (sum, s) => sum + s.pendingTargets.length,
  0
);
...
console.log(`  Share features: TTL ${plan.shareFeatures.ttlDefault} (max ${plan.shareFeatures.ttlMax})`);
