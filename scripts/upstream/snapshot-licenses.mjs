...
for (const entry of repos) {
  ...
  const licensePath = entry.licensePath ? join(repoDir, entry.licensePath) : null;
...
console.log(
  `Summary: ${output.summary.withLicense} with license, ${output.summary.withoutLicense} without, ${output.summary.cautions} cautions`
);
