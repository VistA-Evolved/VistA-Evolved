...
const SKIP_FILES = new Set([
  ...
  "secret-scan.mjs", "secretScanAudit.ts",
]);
...
const SECRET_PATTERNS = [
  {
    ...
    allow: [".env.example", ".md", "AGENTS.md", "BUG-TRACKER.md", ".test.ts", ".spec.ts", "docker-compose", "reference/"],
  },
  {
    name: "AWS Access Key",
  ...
  },
  {
    ...
    allow: [
      ".md", ".env.example", "AGENTS.md", "BUG-TRACKER.md", "secret-scan",
      "verify-", "test-", ".test.ts", ".spec.ts", "login/page.tsx",
      "load-test.mjs", "patient-context.tsx", "login-body.json",
      "secretScanAudit.ts", "authRegressionAudit.ts",
      "e2e/", "e2e-results.json", "k6/", "tools/vista/", "tools/vivian/",
      "evidence/",
    ],
  },
];
