...
async function main() {
  ...
  lines.push(`Totals: ${totals.pass} pass, ${totals.fail} fail, ${totals.warn} warn, ${totals.skip} skip`);
  lines.push(`Severity: ${totals.critical} critical, ${totals.high} high, ${totals.medium} medium, ${totals.low} low, ${totals.info} info`);
  lines.push("");
