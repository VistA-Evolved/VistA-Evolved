...
// 2. Backup script
gate("backup-restore script", fileExists("scripts/backup-restore.mjs"), "scripts/backup-restore.mjs");
...
// 4. Runbook
gate("production posture runbook", fileExists("docs/runbooks/phase107-production-posture.md"), "docs/runbooks/phase107-production-posture.md");
...
gate("security middleware", fileExists("apps/api/src/middleware/security.ts"), "middleware/security.ts");
...
gate("no console.log in posture modules", consoleLogCount === 0, `found ${consoleLogCount} console calls`);
