...
gate("Theme tokens exports built-in themes", () => {
  ...
  return src.includes("BUILT_IN_THEMES") &&
...
gate("Theme tokens exports pack functions", () => {
  const src = readFileSync(join(WEB, "lib", "theme-tokens.ts"), "utf-8");
  return src.includes("export function getThemePack") &&
...
const chartCssFiles = [
  ...
  { name: "PatientHeader.module.css", path: join(WEB, "components", "chart", "PatientHeader.module.css") },
  { name: "panels.module.css", path: join(WEB, "components", "chart", "panels", "panels.module.css") },
];
