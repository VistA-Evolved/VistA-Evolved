...
Assert-Check "Phase 12 IMPLEMENT prompt exists" (Test-Path "$repoRoot\prompts\12-PHASE-12-CPRS-PARITY-WIRING\12-01-cprs-parity-wiring-IMPLEMENT.md")
Assert-Check "Phase 12 VERIFY prompt exists" (Test-Path "$repoRoot\prompts\12-PHASE-12-CPRS-PARITY-WIRING\12-99-cprs-parity-wiring-VERIFY.md")
