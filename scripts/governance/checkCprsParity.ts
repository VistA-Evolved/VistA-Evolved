...
function main() {
  ...
  console.log(`  Actions:  ${s.action.total} total, ${s.action.wired} wired, ${s.action.stub} stub`);
  console.log(`  Gates:    ${s.coreGates.total} total, ${s.coreGates.pass} pass, ${s.coreGates.warn} warn, ${s.coreGates.fail} fail`);
