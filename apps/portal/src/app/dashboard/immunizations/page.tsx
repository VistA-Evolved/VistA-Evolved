      ...
      <div className="card" style={{ marginBottom: "1rem" }}>
        ...
        {loading ? (
          ...
          <div className="empty-state" style={{ padding: "1.5rem" }}>
            <p>{isPending ? "Immunization data pending — VistA integration in progress" : "No immunizations on file"}</p>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }}>
            <thead>
              <tr style={{ borderBottom: "1px solid var(--portal-border, #e2e8f0)" }}>
                <th style={{ textAlign: "left", padding: "0.5rem 0.75rem", fontWeight: 600 }}>Immunization</th>
                <th style={{ textAlign: "left", padding: "0.5rem 0.75rem", fontWeight: 600 }}>Date</th>
                <th style={{ textAlign: "left", padding: "0.5rem 0.75rem", fontWeight: 600 }}>Reaction</th>
              </tr>
            </thead>
            <tbody>
              {results.map((imm) => (
                <tr key={imm.ien} style={{ borderBottom: "1px solid var(--portal-border, #f1f5f9)" }}>
