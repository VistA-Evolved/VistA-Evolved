      ...
      <div className="card" style={{ marginBottom: "1rem" }}>
        ...
        <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap", alignItems: "flex-end" }}>
          <div style={{ flex: 1, minWidth: 180 }}>
            <label style={{ display: "block", fontSize: "0.75rem", color: "#64748b", marginBottom: 2 }}>
              Medication Name
            </label>
            <input
              value={medName}
            ...
            <tbody>
              {refills.map((r) => (
                <tr key={r.id} style={{ borderBottom: "1px solid #f1f5f9" }}>
                  <td style={{ padding: "0.375rem 0.5rem", fontWeight: 500 }}>{r.medicationName}</td>
                  ...
                  <td style={{ padding: "0.375rem 0.5rem", fontSize: "0.8125rem", color: "#64748b" }}>
                    {r.statusNote}
                  </td>
                  <td style={{ padding: "0.375rem 0.5rem" }}>
