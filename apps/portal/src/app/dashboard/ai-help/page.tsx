...
function LabEducationTab() {
  ...
  async function handleExplain() {
    ...
    try {
      ...
      const body = res.data as { ok?: boolean; response?: { content?: string }; error?: string } | undefined;
  ...
  return (
    <div>
      ...
      {error && (
        <div style={{ padding: 12, background: "#fef2f2", border: "1px solid #fecaca", borderRadius: 6, color: "#991b1b", marginBottom: 12 }}>
          {error}
        </div>
      )}
