    ...
    return (
      <div style={pageStyle}>
        <div style={cardStyle}>
          ...
          <p style={{ color: "#64748b" }}>This share link is invalid, expired, or has been revoked.</p>
        </div>
      </div>
    );
  }
        ...
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          <div style={{ ...cardStyle, marginBottom: "1rem" }}>
            ...
            <p style={{ color: "#64748b", fontSize: "0.875rem" }}>
              Patient: {(data as any).patientName} · Expires: {new Date((data as any).expiresAt).toLocaleDateString()}
            </p>
          </div>
      ...
      <div style={cardStyle}>
        ...
        {preview && (
          <p style={{ color: "#64748b", fontSize: "0.875rem", marginBottom: "1rem" }}>
            Shared by: {preview.patientName} · Sections: {preview.sections?.join(", ")}
            · Expires: {new Date(preview.expiresAt).toLocaleDateString()}
          </p>
        )}

        {error && (
          <div style={{ padding: "0.375rem 0.75rem", background: "#fef2f2", color: "#dc2626", borderRadius: 4, marginBottom: "0.75rem", fontSize: "0.8125rem" }}>
            {error}
          </div>
        )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          <div>
            ...
            <input
              ...
              maxLength={6}
              style={{ display: "block", width: "100%", padding: "0.375rem", borderRadius: 4, border: "1px solid #cbd5e1", marginTop: "0.25rem", fontSize: "1rem", letterSpacing: "0.15em", fontWeight: 600 }}
            />
          </div>
          <div>
          ...
          <button
            ...
            disabled={verifying}
            style={{
              padding: "0.5rem", background: verifying ? "#94a3b8" : "#2563eb", color: "#fff",
              border: "none", borderRadius: 4, fontWeight: 600, cursor: verifying ? "not-allowed" : "pointer",
            }}
          >
