    ...
    <div style={containerStyle}>
      ...
      {showQR && resumeToken && (
        <div style={{ ...questionCard, borderColor: '#2563eb', textAlign: 'center' }}>
          ...
          <button
            style={{ ...bigBtn, background: '#e5e7eb', color: '#374151', marginTop: '12px' }}
            ...
            <div key={item.linkId} style={questionCard}>
              ...
              {item.type === 'boolean' && (
                <div style={{ display: 'flex', gap: '12px' }}>
                  <button
                    style={boolBtn(answers[item.linkId] === true)}
                    onClick={() => handleAnswer(item.linkId, true)}
                  >
                    Yes
                  </button>
                  <button
                    style={boolBtn(answers[item.linkId] === false)}
                    onClick={() => handleAnswer(item.linkId, false)}
                  >
                    No
                  </button>
                </div>
