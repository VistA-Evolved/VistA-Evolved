...
test.describe("Record portability — unauthenticated", () => {
  test("POST /portal/record/export without session returns 401", async ({
    request,
  }) => {
  ...
  test("GET /portal/record/exports without session returns 401", async ({
    request,
  }) => {
  ...
  test("GET /portal/record/shares without session returns 401", async ({
    request,
  }) => {
...
test.describe("Record portability — export", () => {
  ...
  test("POST /portal/record/export (PDF) returns ok + token", async ({
    request,
  }) => {
  ...
  test("POST /portal/record/export (HTML) returns ok + token", async ({
    request,
  }) => {
    const res = await authedPost(request, "/portal/record/export", cookie, {
      format: "html",
  ...
  test("GET /portal/record/exports lists created exports", async ({
    request,
  }) => {
  ...
  test("GET /portal/record/export/:token downloads PDF content", async ({
    request,
  }) => {
  ...
  test("GET /portal/record/export/:token downloads HTML content", async ({
    request,
  }) => {
    const createRes = await authedPost(
      request,
  ...
  test("GET /portal/record/export/:badtoken returns 404", async ({
    request,
  }) => {
    const res = await authedGet(
      request,
      "/portal/record/export/bad-token-xyz",
      cookie
    );
...
test.describe("Record portability — share lifecycle", () => {
  ...
  test("create → preview → verify → revoke → denied", async ({ request }) => {
    ...
    const previewRes = await request.get(
      `${API}/portal/record/share/preview/${shareToken}`
    );
    ...
    const verifyRes = await request.post(
      `${API}/portal/record/share/verify/${shareToken}`,
    ...
    const revokeRes = await authedPost(
      request,
      `/portal/record/share/${shareId}/revoke`,
      cookie
    );
