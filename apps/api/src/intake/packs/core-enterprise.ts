...
const coreEnterprisePack: IntakePack = {
  ...
  outputTemplates: {
    hpiTemplate: "Patient presents for: {{core-cc-reason}}. Duration: {{core-cc-duration}}. Severity: {{core-cc-severity}}/10.",
    rosTemplate: "",
    noteTemplate: "DEMOGRAPHICS: Address confirmed: {{core-demo-address-confirm}}. Phone confirmed: {{core-demo-phone-confirm}}.\nCONSENT: Treatment consent: {{core-consent-treatment}}. Privacy acknowledged: {{core-consent-privacy}}.\nCHIEF COMPLAINT: {{core-cc-reason}}. Duration: {{core-cc-duration}}. Severity: {{core-cc-severity}}/10.",
  },
  scoringThresholds: [],
};
