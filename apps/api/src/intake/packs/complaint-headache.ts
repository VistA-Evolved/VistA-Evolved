...
const pack: IntakePack = {
  ...
  items: [
    ...
    },
    {
      linkId: 'ha-quality',
      type: 'choice',
      text: 'How does the headache feel?',
      section: 'hpi',
      required: true,
      order: 31,
      answerOption: [
    ...
    {
      linkId: 'ha-onset-type',
      type: 'choice',
      text: 'How did this headache start?',
      section: 'hpi',
      required: true,
      order: 32,
      answerOption: [
    ...
    {
      linkId: 'ha-thunderclap',
      type: 'display',
      text: 'IMPORTANT: A sudden, severe headache that comes on in seconds needs immediate evaluation. Please inform staff immediately.',
      section: 'hpi',
      required: false,
      order: 33,
      enableWhen: [{ question: 'ha-onset-type', operator: '=', answer: 'sudden' }],
      redFlag: {
        condition: 'ha-onset-type=sudden',
        message: 'Thunderclap headache - rule out SAH',
        severity: 'critical',
      },
    },
    {
      linkId: 'ha-worst-ever',
      type: 'boolean',
      ...
      redFlag: {
        condition: 'true',
        message: 'Worst headache ever - SAH/meningitis concern',
        severity: 'critical',
      },
    },
    {
    ...
    },
    {
      linkId: 'ha-aura',
      type: 'boolean',
      text: 'Do you see flashing lights, zigzag lines, or have vision changes before the headache?',
      section: 'hpi',
      required: true,
      order: 36,
    },
    {
      linkId: 'ha-photophobia',
      type: 'boolean',
    ...
    {
      linkId: 'ha-phonophobia',
      type: 'boolean',
      text: 'Does noise bother you during the headache?',
      section: 'ros',
      required: true,
      order: 41,
    },
    {
      linkId: 'ha-nausea',
      type: 'boolean',
      text: 'Do you feel nauseous or vomit with the headache?',
      section: 'ros',
      required: true,
      order: 42,
    },
    {
      linkId: 'ha-neck-stiffness',
      type: 'boolean',
      ...
      redFlag: {
        condition: 'true',
        message: 'Neck stiffness with headache - meningitis concern',
        severity: 'high',
      },
    },
    {
      ...
      redFlag: {
        condition: 'true',
        message: 'Fever with headache - infection concern',
        severity: 'high',
      },
    },
    {
      linkId: 'ha-vision-change',
      type: 'boolean',
      text: 'Any new vision changes (blurry, double vision, loss of vision)?',
      section: 'ros',
      required: true,
      order: 45,
      redFlag: {
        condition: 'true',
        message: 'Vision changes with headache - ICP/mass/GCA concern',
        severity: 'high',
      },
    },
    {
      linkId: 'ha-weakness',
      type: 'boolean',
      text: 'Any new weakness, numbness, or difficulty speaking?',
      section: 'ros',
      required: true,
      order: 46,
      redFlag: {
        condition: 'true',
        message: 'Focal neuro deficits - stroke/mass concern',
        severity: 'critical',
      },
    },
    {
      linkId: 'ha-triggers',
      type: 'open-choice',
      text: 'What triggers or worsens the headache?',
      section: 'hpi',
      required: false,
      order: 37,
      answerOption: [
  ...
  outputTemplates: {
    hpiTemplate:
      'Headache: {{ha-quality}}, {{ha-location}}. Onset: {{ha-onset-type}}. Frequency: {{ha-frequency}}. Aura: {{ha-aura}}. Triggers: {{ha-triggers}}.',
    rosTemplate:
      'NEURO: Photophobia {{ha-photophobia}}, phonophobia {{ha-phonophobia}}, vision changes {{ha-vision-change}}, focal deficits {{ha-weakness}}. GI: Nausea {{ha-nausea}}. MSK: Neck stiffness {{ha-neck-stiffness}}. GENERAL: Fever {{ha-fever}}.',
    noteTemplate: '',
  },
  scoringThresholds: [],
};
