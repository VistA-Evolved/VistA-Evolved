...
const ADT_EVENTS = [
  ...
  "ADT^A05", "ADT^A06", "ADT^A07", "ADT^A08",
];
...
export function buildAdtA01(
  ...
  visit: VisitInfo,
  opts?: { sendingApp?: string; sendingFacility?: string; receivingApp?: string; receivingFacility?: string },
): string {
...
export const adtPack: MessagePack = {
  ...
  getRouteTemplate: () => ({
    ...
    transforms: [],
    destination: { type: "dead-letter" as const, id: "adt-dlq", name: "ADT Dead Letter", target: "" },
  }),
};
