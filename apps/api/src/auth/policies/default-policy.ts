...
export const DEFAULT_ROLES: RoleDefinition[] = [
  {
    ...
    allowedPatterns: ["clinical.*", "phi.*", "imaging.view", "imaging.order", "report.generate", "telehealth.*", "analytics.view"],
  ...
  },
  {
    ...
    allowedPatterns: ["clinical.vitals-add", "clinical.note-create", "clinical.draft-*", "phi.*", "imaging.view", "report.generate", "telehealth.join", "analytics.view"],
