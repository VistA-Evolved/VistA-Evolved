...
function seedLocales() {
  const base: Omit<LocaleDefinition, "id" | "createdAt">[] = [
    { languageTag: "en-US", nativeName: "English (US)", englishName: "English (US)", direction: "ltr", dateFormat: "MM/DD/YYYY", decimalSeparator: ".", thousandsSeparator: ",", defaultUnitProfileId: null, enabled: true },
    { languageTag: "en-GB", nativeName: "English (UK)", englishName: "English (UK)", direction: "ltr", dateFormat: "DD/MM/YYYY", decimalSeparator: ".", thousandsSeparator: ",", defaultUnitProfileId: null, enabled: true },
    { languageTag: "fil-PH", nativeName: "Filipino", englishName: "Filipino (Philippines)", direction: "ltr", dateFormat: "MM/DD/YYYY", decimalSeparator: ".", thousandsSeparator: ",", defaultUnitProfileId: null, enabled: true },
    { languageTag: "es-MX", nativeName: "Espanol (Mexico)", englishName: "Spanish (Mexico)", direction: "ltr", dateFormat: "DD/MM/YYYY", decimalSeparator: ".", thousandsSeparator: ",", defaultUnitProfileId: null, enabled: true },
  ];
...
export function createLocale(
  loc: Omit<LocaleDefinition, "id" | "createdAt">
): LocaleDefinition {
...
export function listTranslationBundles(tenantId?: string, languageTag?: string): TranslationBundle[] {
...
export function getLocalizationDashboardStats(): LocalizationDashboardStats {
  ...
  const totalKeys = allBundles.reduce(
    (sum, b) => sum + Object.keys(b.translations).length,
    0
  );
