...
const DEFAULT_BACKUP_DIR = resolve(process.env.PG_BACKUP_DIR || 'artifacts/backups/pg');
 ...
 */
export async function handlePgBackup(payload: Record<string, unknown>): Promise<void> {
