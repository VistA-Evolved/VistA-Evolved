...
export type DocumentCategory = "clinical-note" | "discharge-summary" | "laboratory" | "imaging" | "referral" | "consent" | "administrative" | "other";
export type DocumentFormat = "urn:ihe:iti:xds:2017:mimeTypeSufficient" | "urn:ihe:pcc:xphr:2007" | "urn:hl7-org:sdwg:ccda-structuredBody:2.1" | "application/fhir+json" | "text/plain" | "application/pdf";
