...
export const PROBLEMS_RPCS: ProblemsRpc[] = [
  ...
  { name: "ORQQPL CLIN FILTER LIST", slug: "orqqpl-clin-filter-list", isContext: false, referenceCount: 1 },
  ...
  { name: "ORQQPL PROB COMMENTS", slug: "orqqpl-prob-comments", isContext: false, referenceCount: 1 },
  { name: "ORQQPL PROBLEM LIST", slug: "orqqpl-problem-list", isContext: false, referenceCount: 1 },
  { name: "ORQQPL PROBLEM NTRT BULLETIN", slug: "orqqpl-problem-ntrt-bulletin", isContext: false, referenceCount: 1 },
  { name: "ORQQPL PROV FILTER LIST", slug: "orqqpl-prov-filter-list", isContext: false, referenceCount: 1 },
  { name: "ORQQPL PROVIDER LIST", slug: "orqqpl-provider-list", isContext: false, referenceCount: 1 },
  ...
  { name: "ORQQPL SERV FILTER LIST", slug: "orqqpl-serv-filter-list", isContext: false, referenceCount: 1 },
  ...
  { name: "ORQQPL USER PROB CATS", slug: "orqqpl-user-prob-cats", isContext: false, referenceCount: 1 },
  { name: "ORQQPL USER PROB LIST", slug: "orqqpl-user-prob-list", isContext: false, referenceCount: 1 },
...
export default async function problemsRoutes(server: FastifyInstance): Promise<void> {
  ...
  server.get("/vista/problems/rpc/orqqpl-problem-ntrt-bulletin", async (): Promise<StubResponse> => {
    return {
      ok: false,
      error: "Not implemented",
