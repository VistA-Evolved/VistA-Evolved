...
export default async function cprsWave2Routes(server: FastifyInstance): Promise<void> {
  ...
  /* POST /vista/cprs/orders/dc -- canonical route moved to orders-cpoe.ts (Phase 154) */

  /* POST /vista/cprs/orders/flag -- canonical route moved to orders-cpoe.ts (Phase 154) */
