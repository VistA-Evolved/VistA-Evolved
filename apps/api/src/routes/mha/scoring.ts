...
const SCORING_RULES: Record<string, ScoringRule> = {
  ...
  "pcl-5": {
    ...
    thresholds: [
      ...
      { min: 31, max: 32, severity: "borderline", interpretation: "Borderline -- consider further evaluation" },
      { min: 33, max: 80, severity: "probable-ptsd", interpretation: "Probable PTSD -- clinical evaluation recommended" },
    ],
  },
  "c-ssrs": {
    instrumentId: "c-ssrs",
    ...
    thresholds: [
      ...
      { min: 1, max: 2, severity: "low", interpretation: "Low risk -- wish to be dead or non-specific thoughts" },
      { min: 3, max: 4, severity: "moderate", interpretation: "Moderate risk -- method or intent identified" },
      { min: 5, max: 6, severity: "high", interpretation: "High risk -- plan with intent or recent behavior" },
    ],
  ...
  "audit-c": {
    ...
    thresholds: [
      ...
      { min: 3, max: 3, severity: "at-risk-female", interpretation: "At-risk drinking (female threshold)" },
