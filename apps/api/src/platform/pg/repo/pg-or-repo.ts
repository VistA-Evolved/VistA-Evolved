...
export async function findOrCasesByStatus(
  status: string,
  tenantId = 'default'
): Promise<OrCaseRow[]> {
  const db = getPgDb();
...
export async function findOrCasesByPatient(
  patientDfn: string,
  tenantId = 'default'
): Promise<OrCaseRow[]> {
  const db = getPgDb();
...
export async function findOrRoomsByStatus(
  status: string,
  tenantId = 'default'
): Promise<OrRoomRow[]> {
  const db = getPgDb();
...
export async function findOrBlocksByRoom(
  roomId: string,
  tenantId = 'default'
): Promise<OrBlockRow[]> {
  const db = getPgDb();
