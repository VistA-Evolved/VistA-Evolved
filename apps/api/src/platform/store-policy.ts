...
export const STORE_INVENTORY: StoreEntry[] = [
  ...
  },
  {
    ...
    notes: "Phase 442: Export pipeline with cross-border, PHI, retention constraint checks. Resets on restart.",
  },
  {
    id: "export-audit",
    file: "regulatory/export-pipeline.ts",
  ...
  // ── Phase 394: Imaging/Radiology Deep Workflows (W22-P6) ───
  {
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "radiology",
    migrationTarget: "pg: radiology_order (future)",
    notes: "Phase 394: Rad order FSM with protocol assignment and W21 MWL/MPPS linking.",
  },
  {
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "radiology",
    migrationTarget: "pg: radiology_reading_worklist (future)",
    notes: "Phase 394: Study-to-reader assignment with priority and turnaround tracking.",
  },
  {
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "radiology",
    migrationTarget: "pg: radiology_report (future)",
    notes: "Phase 394: Draft -> prelim -> final report workflow with TIU bridging.",
  },
  {
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "radiology",
    migrationTarget: "pg: radiology_dose_registry (future)",
    notes: "Phase 394: DRL threshold evaluation, cumulative patient dose tracking.",
  },
  {
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "radiology",
    migrationTarget: "pg: radiology_critical_alert (future)",
    notes: "Phase 394: ACR-aligned critical finding communication tracking.",
  },
  {
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "radiology",
    migrationTarget: "pg: radiology_peer_review (future)",
    notes: "Phase 394: 4-point discrepancy scoring for quality assurance.",
  },
  ...
  // ED stores (Phase 464)
  {
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "clinical",
    migrationTarget: "pg: ed_visits (future) or VistA EDIS",
    notes: "Phase 464: 13-state visit lifecycle, reset on restart.",
  },
  {
    id: "ed-beds",
    file: "service-lines/ed/ed-store.ts",
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "clinical",
    migrationTarget: "pg: ed_beds (future) or VistA EDIS",
    notes: "Phase 464: 26 default beds across 4 zones, seeded on init.",
  },
  // OR stores (Phase 466)
  {
    id: "or-cases",
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "clinical",
    migrationTarget: "pg: or_cases (future) or VistA Surgery 130",
    notes: "Phase 466: 12-status case lifecycle with milestone tracking.",
  },
  {
    id: "or-rooms",
    file: "service-lines/or/or-store.ts",
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "clinical",
    migrationTarget: "pg: or_rooms (future) or VistA Surgery 131.7",
    notes: "Phase 466: 6 default rooms, seeded on init.",
  },
  {
    id: "or-blocks",
    file: "service-lines/or/or-store.ts",
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "clinical",
    migrationTarget: "pg: or_blocks (future)",
    notes: "Phase 466: Service/surgeon block time allocation.",
  },
  // ICU stores (Phase 468)
  {
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "clinical",
    migrationTarget: "pg: icu_admissions (future)",
    notes: "Phase 468: 5-status admission lifecycle, reset on restart.",
  },
  {
    id: "icu-beds",
    file: "service-lines/icu/icu-store.ts",
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "clinical",
    migrationTarget: "pg: icu_beds (future)",
    notes: "Phase 468: 28 beds across MICU/SICU/CCU/NICU, seeded on init.",
  },
  {
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "clinical",
    migrationTarget: "pg: icu_flowsheet_entries (future)",
    notes: "Phase 468: 9 categories of clinical observations.",
  },
  {
    id: "icu-vent-records",
    file: "service-lines/icu/icu-store.ts",
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "clinical",
    migrationTarget: "pg: icu_vent_records (future)",
    notes: "Phase 468: 8 ventilation modes tracked with params.",
  },
  {
    id: "icu-io-records",
    file: "service-lines/icu/icu-store.ts",
    ...
    durability: "in_memory_only" as DurabilityStatus,
    domain: "clinical",
    migrationTarget: "pg: icu_io_records (future)",
    notes: "Phase 468: 11 I/O sources with net balance calculation.",
  },
  {
    id: "icu-scores",
    file: "service-lines/icu/icu-store.ts",
