...
export const STORE_INVENTORY: StoreEntry[] = [
  ...
  // ─── Writeback Command Bus (Phase 300) ─────────────────────────
  {
    ...
    notes: "Phase 300: Command bus persistence. PG table exists; wiring TBD.",
  },
  {
    ...
    notes: "Phase 300: Attempt log for retry tracking.",
  },
  {
    ...
    notes: "Phase 300: Final result store.",
  },
  {
    ...
    durability: "pg_backed",
    domain: "writeback",
    notes: "Phase 300: Derived from clinical_command UNIQUE (tenant_id, idempotency_key).",
  },
  {
