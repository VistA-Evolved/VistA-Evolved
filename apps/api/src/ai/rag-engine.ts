 ...
 */
export function registerRAGProvider(
  ...
  return Promise.resolve([
    {
      ...
      content: "1. Essential Hypertension (I10)\n2. Type 2 Diabetes Mellitus (E11.9)\n3. Obesity (E66.9)",
      dataTimestamp: new Date().toISOString(),
    },
  ]);
}
  ...
  return Promise.resolve([
    {
      ...
      content: "1. Primary Care Follow-up - Feb 25, 2025 10:00 AM\n2. Ophthalmology - Mar 10, 2025 2:30 PM",
      dataTimestamp: new Date().toISOString(),
    },
  ]);
}
...
export async function assembleContext(
  ...
  const excludedCategories = (requestedCategories ?? allowedCategories)
