...
export class VistaBillingAdapter implements BillingAdapter {
  ...
  async getClaims(): Promise<AdapterResult<Claim[]>> { return PENDING; }
  async submitClaim(): Promise<AdapterResult<Claim>> { return PENDING; }
  async getEOB(): Promise<AdapterResult<EOB>> { return PENDING; }
  async getEligibility(): Promise<AdapterResult<EligibilityResult>> { return PENDING; }
}
