...
export function initSwitchboard(): void {
  ...
  registerWorkflow({
    name: 'rcm-claim',
    description: 'Revenue cycle claim lifecycle: draft through payment/denial/appeal',
    domain: 'rcm',
    phase: 38,
  ...
  registerWorkflow({
    ...
    description: 'Department workflow instance lifecycle: start through completion',
    domain: 'clinical',
    phase: 160,
