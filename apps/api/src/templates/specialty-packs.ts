  ...
  return {
    ...
    fields: [
      { key: 'pe_general', label: 'General Appearance', fieldType: 'textarea', order: 1 },
      {
        ...
        fieldType: 'text',
        order: 2,
        mappingTarget: { vistaReadRpc: 'GMV VITALS/CAT/QUAL', vistaReadStatus: 'available' },
      },
    ...
    fields: [
      {
        ...
        fieldType: 'textarea',
        order: 1,
        mappingTarget: { vistaReadRpc: 'ORWPS ACTIVE', vistaReadStatus: 'available' },
      },
      { key: 'meds_changes', label: 'Medication Changes', fieldType: 'textarea', order: 2 },
      {
        ...
        fieldType: 'textarea',
        order: 3,
        mappingTarget: { vistaReadRpc: 'ORQQAL LIST', vistaReadStatus: 'available' },
      },
    ],
  };
}
    ...
    fields: [
      {
        ...
        fieldType: 'select',
        order: 1,
        allowedValues: ['Never', 'Former', 'Current', 'Unknown'],
      },
      {
        key: 'sh_alcohol',
        label: 'Alcohol Use',
        fieldType: 'select',
        order: 2,
        allowedValues: ['None', 'Social', 'Heavy', 'Unknown'],
      },
    ...
    fields: [
      {
        ...
        fieldType: 'textarea',
        order: 1,
        mappingTarget: { vistaReadRpc: 'ORQQPL LIST', vistaReadStatus: 'available' },
      },
      { key: 'pmh_surgeries', label: 'Past Surgeries', fieldType: 'textarea', order: 2 },
      {
        key: 'pmh_hospitalizations',
        label: 'Prior Hospitalizations',
        fieldType: 'textarea',
        order: 3,
      },
    ],
...
function familyHistorySection(order: number): TemplateSection {
  return {
    ...
    collapsible: true,
    defaultExpanded: false,
    fields: [{ key: 'fhx_details', label: 'Family History', fieldType: 'textarea', order: 1 }],
  };
}
    ...
    // 1. Primary Care
    {
      ...
      templates: [
        makeTemplate('Primary Care Office Visit', 'primary-care', 'outpatient', [
          ...
          rosSection(2),
          pmhSection(3),
          socialHistorySection(4),
          familyHistorySection(5),
          medicationsSection(6),
          peSection(7),
          assessmentPlanSection(8),
        ]),
    ...
    // 4. Pediatrics
    {
      ...
      templates: [
        makeTemplate('Pediatric Well-Child Visit', 'pediatrics', 'outpatient', [
          ...
          peSection(1),
          medicationsSection(2),
          {
            id: 'peds-imm',
            type: 'checkbox',
            title: 'Immunizations Reviewed',
            order: 3,
            collapsible: true,
            defaultExpanded: true,
            fields: [
        ...
        makeTemplate('ED Evaluation', 'emergency-medicine', 'ed', [
          {
            ...
            fields: [
              ...
              },
              {
                ...
                fieldType: 'select',
                order: 2,
                allowedValues: ['Ambulatory', 'Wheelchair', 'Stretcher', 'Ambulance', 'Police'],
              },
          ...
          },
          {
            ...
            fields: [
              {
                key: 'mdm_complexity',
                label: 'MDM Complexity',
                fieldType: 'select',
                order: 1,
                allowedValues: ['Straightforward', 'Low', 'Moderate', 'High'],
              },
            ...
            fields: [
              {
                ...
                fieldType: 'select',
                order: 1,
                allowedValues: ['Discharge', 'Admit', 'Transfer', 'AMA', 'Observation', 'Deceased'],
              },
              {
                key: 'dispo_instructions',
          ...
          hpiSection(1),
          {
            ...
            fields: [
              ...
              { key: 'neph_bun', label: 'BUN', fieldType: 'number', order: 3 },
              {
                ...
                fieldType: 'select',
                order: 4,
                allowedValues: ['None', 'Hemodialysis', 'Peritoneal Dialysis', 'Planning'],
              },
            ],
          },
          rosSection(3),
      ...
      templates: [
        makeTemplate('Neurology Consult', 'neurology', 'any', [
          hpiSection(1),
          {
            ...
            fields: [
              {
                key: 'neuro_mental_status',
                label: 'Mental Status',
                fieldType: 'textarea',
                order: 1,
              },
              {
                key: 'neuro_cranial_nerves',
    ...
    // 13. Psychiatry
    {
      ...
      templates: [
        makeTemplate('Psychiatric Evaluation', 'psychiatry', 'any', [
          ...
          pmhSection(4),
          medicationsSection(5),
          socialHistorySection(6),
          assessmentPlanSection(7),
        ]),
      ],
    },
        ...
        makeTemplate('Orthopedic Evaluation', 'orthopedics', 'outpatient', [
          hpiSection(1),
          {
            ...
            fields: [
              ...
              {
                key: 'ortho_special_tests',
                label: 'Special Tests',
                fieldType: 'textarea',
                order: 4,
              },
              {
                key: 'ortho_neurovascular',
        ...
        makeTemplate('Surgical Pre-Op Note', 'general-surgery', 'inpatient', [
          { id: 'preop-header', type: 'header', title: 'PRE-OPERATIVE NOTE', order: 0, fields: [] },
          {
            ...
            fields: [
              ...
              {
                key: 'preop_site_marked',
                label: 'Surgical Site Marked',
                fieldType: 'checkbox',
                order: 5,
              },
              {
                key: 'preop_antibiotics',
                label: 'Prophylactic Antibiotics',
                fieldType: 'text',
                order: 6,
              },
            ],
          ...
          { id: 'op-header', type: 'header', title: 'OPERATIVE REPORT', order: 0, fields: [] },
          {
            ...
            fields: [
              ...
              { key: 'op_assistants', label: 'Assistants', fieldType: 'text', order: 5 },
              {
                ...
                fieldType: 'select',
                order: 6,
                allowedValues: ['General', 'Spinal', 'Epidural', 'Regional', 'Local', 'MAC'],
              },
        ...
        makeTemplate('Anesthesia Pre-Assessment', 'anesthesia', 'inpatient', [
          {
            ...
            fields: [
              ...
              { key: 'anes_npo_status', label: 'NPO Status', fieldType: 'text', order: 3 },
              {
                ...
                fieldType: 'select',
                order: 4,
                allowedValues: ['General', 'Spinal', 'Epidural', 'Regional Block', 'MAC', 'Local'],
              },
              {
                key: 'anes_risk_discuss',
        ...
        makeTemplate('ENT Evaluation', 'ent-otolaryngology', 'outpatient', [
          hpiSection(1),
          {
            ...
            fields: [
              ...
              {
                key: 'ent_neck',
                label: 'Neck (Lymph nodes, thyroid)',
                fieldType: 'textarea',
                order: 5,
              },
        ...
        makeTemplate('GI Consult', 'gastroenterology', 'any', [
          hpiSection(1),
          {
            ...
            fields: [
              ...
              {
                key: 'gi_prior_scope',
                label: 'Prior Endoscopy/Colonoscopy',
                fieldType: 'textarea',
                order: 4,
              },
            ],
      ...
      templates: [
        makeTemplate('Radiology Report Template', 'radiology', 'any', [
            ...
            fields: [
              {
                ...
                fieldType: 'select',
                order: 1,
                allowedValues: ['XR', 'CT', 'MRI', 'US', 'NM', 'PET', 'Fluoro', 'Mammo'],
              },
          ...
          },
          {
            ...
            title: 'Findings',
            order: 2,
            fields: [{ key: 'rad_findings', label: 'Findings', fieldType: 'textarea', order: 1 }],
          },
          {
            id: 'rad-impression',
            type: 'text',
        ...
        makeTemplate('Lab Order Workflow Note', 'laboratory', 'any', [
          {
            ...
            fields: [
              ...
              { key: 'lab_specimen_type', label: 'Specimen Type', fieldType: 'text', order: 3 },
              {
                ...
                fieldType: 'select',
                order: 4,
                allowedValues: ['Routine', 'STAT', 'Timed', 'ASAP'],
              },
        ...
        makeTemplate('Nursing Shift Note', 'nursing', 'inpatient', [
          { id: 'nurse-header', type: 'header', title: 'NURSING SHIFT NOTE', order: 0, fields: [] },
          {
            ...
            fields: [
              ...
              {
                key: 'nurse_safety',
                label: 'Safety (fall risk, restraints)',
                fieldType: 'textarea',
                order: 8,
              },
            ],
        ...
        makeTemplate('Rehab Progress Note', 'rehabilitation', 'inpatient', [
          {
            id: 'rehab-status',
            type: 'text',
            title: 'Rehabilitation Status',
            order: 1,
            fields: [
              { key: 'rehab_fim', label: 'FIM Score', fieldType: 'number', order: 1 },
              {
                key: 'rehab_goals_progress',
                label: 'Goals Progress',
                fieldType: 'textarea',
                order: 2,
              },
              {
                key: 'rehab_therapy_summary',
                label: 'Therapy Summary',
                fieldType: 'textarea',
                order: 3,
              },
              {
                key: 'rehab_discharge_plan',
      ...
      templates: [
        makeTemplate('Dental Evaluation', 'dental', 'outpatient', [
          hpiSection(1),
          {
            id: 'dental-exam',
            type: 'text',
            title: 'Oral/Dental Examination',
            order: 2,
            fields: [
              {
                key: 'dental_soft_tissue',
                label: 'Soft Tissue Exam',
                fieldType: 'textarea',
                order: 1,
              },
              {
                key: 'dental_hard_tissue',
                label: 'Hard Tissue/Teeth',
                fieldType: 'textarea',
                order: 2,
              },
              {
                key: 'dental_periodontal',
                label: 'Periodontal Status',
                fieldType: 'textarea',
                order: 3,
              },
              {
                key: 'dental_radiographs',
      ...
      templates: [
        makeTemplate('Urology Evaluation', 'urology', 'outpatient', [
          hpiSection(1),
          {
            id: 'uro-specific',
            type: 'text',
            title: 'Urologic Assessment',
            order: 2,
            fields: [
              {
                key: 'uro_lower_tract',
                label: 'Lower Urinary Tract Symptoms',
                fieldType: 'textarea',
                order: 1,
              },
      ...
      templates: [
        makeTemplate('Rheumatology Consult', 'rheumatology', 'outpatient', [
          hpiSection(1),
          {
            ...
            fields: [
              {
                key: 'rheum_active_joints',
                label: 'Active Joints',
                fieldType: 'textarea',
                order: 1,
              },
              {
                key: 'rheum_swollen_count',
                label: 'Swollen Joint Count',
                fieldType: 'number',
                order: 2,
              },
              {
                key: 'rheum_tender_count',
                label: 'Tender Joint Count',
                fieldType: 'number',
                order: 3,
              },
              {
                key: 'rheum_morning_stiffness',
        ...
        makeTemplate('Palliative Care Consult', 'palliative-care', 'any', [
          hpiSection(1),
          {
            ...
            fields: [
              ...
              {
                key: 'pall_spiritual',
                label: 'Spiritual/Psychosocial Needs',
                fieldType: 'textarea',
                order: 5,
              },
            ],
        ...
        makeTemplate('Geriatric Assessment', 'geriatrics', 'outpatient', [
          hpiSection(1),
          {
            ...
            fields: [
              ...
              {
                key: 'geri_cognition',
                label: 'Cognitive Screen (MMSE/MoCA)',
                fieldType: 'text',
                order: 4,
              },
              {
        ...
        makeTemplate('Allergy/Immunology Consult', 'allergy-immunology', 'outpatient', [
          hpiSection(1),
          {
            ...
            fields: [
              ...
              {
                key: 'allg_testing',
                label: 'Allergy Testing Results',
                fieldType: 'textarea',
                order: 2,
              },
              {
                key: 'allg_immunotherapy',
                label: 'Immunotherapy Status',
                fieldType: 'text',
                order: 3,
              },
              {
                key: 'allg_emergency_plan',
        ...
        makeTemplate('Plastic Surgery Consult', 'plastic-surgery', 'any', [
          hpiSection(1),
          {
            ...
            fields: [
              ...
              {
                key: 'plastics_wound',
                label: 'Wound/Defect Description',
                fieldType: 'textarea',
                order: 2,
              },
        ...
        makeTemplate('Podiatry Evaluation', 'podiatry', 'outpatient', [
          hpiSection(1),
          {
            ...
            fields: [
              ...
              {
                key: 'pod_neuro',
                label: 'Neurological (monofilament)',
                fieldType: 'textarea',
                order: 3,
              },
        ...
        makeTemplate('Nutrition Assessment', 'nutrition-dietetics', 'any', [
          {
            ...
            fields: [
              ...
              {
                key: 'nutr_requirements',
                label: 'Caloric/Protein Requirements',
                fieldType: 'text',
                order: 4,
              },
              {
                key: 'nutr_restrictions',
                label: 'Dietary Restrictions',
                fieldType: 'textarea',
                order: 5,
              },
              {
                key: 'nutr_recommendations',
        ...
        makeTemplate('Social Work Assessment', 'social-work', 'any', [
          {
            ...
            fields: [
              ...
              {
                key: 'sw_financial',
                label: 'Financial/Insurance Concerns',
                fieldType: 'textarea',
                order: 4,
              },
              ...
              {
                key: 'sw_resources',
                label: 'Resources/Referrals Provided',
                fieldType: 'textarea',
                order: 7,
              },
            ],
        ...
        makeTemplate('Clinical Pharmacy Review', 'pharmacy-clinical', 'any', [
          {
            ...
            fields: [
              ...
              {
                key: 'pharm_interactions',
                label: 'Drug Interactions Identified',
                fieldType: 'textarea',
                order: 2,
              },
              {
                key: 'pharm_duplicates',
                label: 'Therapeutic Duplications',
                fieldType: 'textarea',
                order: 3,
              },
              {
                key: 'pharm_dose_adjust',
                label: 'Dose Adjustments Recommended',
                fieldType: 'textarea',
                order: 4,
              },
              {
                key: 'pharm_monitoring',
                label: 'Monitoring Recommendations',
                fieldType: 'textarea',
                order: 5,
              },
              {
                key: 'pharm_recommendations',
                label: 'Pharmacist Recommendations',
                fieldType: 'textarea',
                order: 6,
              },
            ],
        ...
        makeTemplate('Pain Management Evaluation', 'pain-management', 'outpatient', [
          hpiSection(1),
          {
            ...
            fields: [
              ...
              {
                key: 'pain_functional_impact',
                label: 'Functional Impact',
                fieldType: 'textarea',
                order: 4,
              },
              {
                key: 'pain_prior_treatments',
                label: 'Prior Treatments',
                fieldType: 'textarea',
                order: 5,
              },
              {
                key: 'pain_opioid_risk',
                label: 'Opioid Risk Assessment',
                fieldType: 'textarea',
                order: 6,
              },
              {
                key: 'pain_pdmp_reviewed',
                label: 'PDMP Reviewed',
                fieldType: 'checkbox',
                order: 7,
              },
          ...
          [
            { id: 'dc-header', type: 'header', title: 'DISCHARGE SUMMARY', order: 0, fields: [] },
            {
              ...
              fields: [
                ...
                {
                  key: 'dc_discharge_meds',
                  label: 'Discharge Medications',
                  fieldType: 'textarea',
                  order: 7,
                },
                {
                  key: 'dc_discharge_instructions',
                  label: 'Discharge Instructions',
                  fieldType: 'textarea',
                  order: 8,
                },
                ...
                },
                {
                  ...
                  fieldType: 'select',
                  order: 10,
                  allowedValues: ['Stable', 'Improved', 'Fair', 'Guarded', 'Critical'],
                },
              ],
            },
          ],
          ['internal-medicine', 'discharge'],
          'Inpatient discharge summary template'
        ),
      ],
    },
  ];
