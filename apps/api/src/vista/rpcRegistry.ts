...
export const RPC_REGISTRY: RpcDefinition[] = [
  ...
  { name: 'ORWDLR32 ABBSPEC', domain: 'labs', tag: 'read', description: 'Lab order dialog abbrev specimen' },
  { name: 'ORWDLR32 ALLSAMP', domain: 'labs', tag: 'read', description: 'Lab order dialog all samples' },
  { name: 'ORWDLR32 ALLSPEC', domain: 'labs', tag: 'read', description: 'Lab order dialog all specimens' },
  { name: 'ORWDLR32 DEF', domain: 'labs', tag: 'read', description: 'Lab order dialog default' },
  { name: 'ORWDLR32 GET LAB TIMES', domain: 'labs', tag: 'read', description: 'Lab order dialog lab times' },
  { name: 'ORWDLR32 IC DEFAULT', domain: 'labs', tag: 'read', description: 'Lab order dialog IC default' },
  { name: 'ORWDLR32 IC VALID', domain: 'labs', tag: 'read', description: 'Lab order dialog IC valid' },
  { name: 'ORWDLR32 IMMED COLLECT', domain: 'labs', tag: 'read', description: 'Lab order dialog immediate collect' },
  { name: 'ORWDLR32 LAB COLL TIME', domain: 'labs', tag: 'read', description: 'Lab order dialog collection time' },
  { name: 'ORWDLR32 LOAD', domain: 'labs', tag: 'read', description: 'Lab order dialog load' },
  { name: 'ORWDLR32 MAXDAYS', domain: 'labs', tag: 'read', description: 'Lab order dialog max days' },
  { name: 'ORWDLR32 ONE SAMPLE', domain: 'labs', tag: 'read', description: 'Lab order dialog one sample' },
  { name: 'ORWDLR32 ONE SPECIMEN', domain: 'labs', tag: 'read', description: 'Lab order dialog one specimen' },
  { name: 'ORWDLR32 STOP', domain: 'labs', tag: 'read', description: 'Lab order dialog stop' },
  { name: 'ORWDLR33 FUTURE LAB COLLECTS', domain: 'labs', tag: 'read', description: 'Future lab collects' },
  { name: 'ORWDLR33 LASTTIME', domain: 'labs', tag: 'read', description: 'Lab last collection time' },
  ...
  { name: 'ORWDPS1 DOWSCH', domain: 'medications', tag: 'read', description: 'Days of week schedule' },
  ...
  { name: 'ORWDPS1 QOMEDALT', domain: 'medications', tag: 'read', description: 'QO med alternatives' },
  ...
  { name: 'ORWDPS2 OISLCT', domain: 'medications', tag: 'read', description: 'Orderable item select' },
  ...
  { name: 'ORWDPS32 FORMALT', domain: 'medications', tag: 'read', description: 'Form alternatives' },
  ...
  { name: 'ORWDPS32 OISLCT', domain: 'medications', tag: 'read', description: 'Orderable item select' },
  ...
  { name: 'ORWDPS33 COMPLOC', domain: 'medications', tag: 'read', description: 'Compound location' },
  ...
  { name: 'ORWDXA COMPLETE', domain: 'orders', tag: 'write', description: 'Complete order (IEN 396 in VEHU)' },
  { name: 'ORWDXA HOLD', domain: 'orders', tag: 'write', description: 'Hold order (IEN 388 in VEHU)' },
  ...
  { name: 'ORWRP COLUMN HEADERS', domain: 'reports', tag: 'read', description: 'Report column headers' },
  { name: 'ORWRP GET DEFAULT PRINTER', domain: 'reports', tag: 'read', description: 'Get default printer' },
  { name: 'ORWRP LAB REPORT LISTS', domain: 'reports', tag: 'read', description: 'Lab report lists' },
  { name: 'ORWRP PRINT LAB REMOTE', domain: 'reports', tag: 'read', description: 'Print lab remote' },
  { name: 'ORWRP PRINT LAB REPORTS', domain: 'reports', tag: 'read', description: 'Print lab reports' },
  { name: 'ORWRP PRINT REMOTE REPORT', domain: 'reports', tag: 'read', description: 'Print remote report' },
  ...
  { name: 'ORWRP PRINT WINDOWS LAB REMOTE', domain: 'reports', tag: 'read', description: 'Print Windows lab remote' },
  { name: 'ORWRP PRINT WINDOWS REMOTE', domain: 'reports', tag: 'read', description: 'Print Windows remote' },
  { name: 'ORWRP PRINT WINDOWS REPORT', domain: 'reports', tag: 'read', description: 'Print Windows report' },
  { name: 'ORWRP SAVE DEFAULT PRINTER', domain: 'reports', tag: 'write', description: 'Save default printer' },
  { name: 'ORWRP WINPRINT DEFAULT', domain: 'reports', tag: 'read', description: 'Winprint default' },
  { name: 'ORWRP WINPRINT LAB REPORTS', domain: 'reports', tag: 'read', description: 'Winprint lab reports' },
  { name: 'ORWRP1 LISTNUTR', domain: 'reports', tag: 'read', description: 'List nutrition reports' },
  ...
  { name: 'ORWRP2 HS COMP FILES', domain: 'reports', tag: 'read', description: 'HS component files' },
  { name: 'ORWRP2 HS COMPONENT SUBS', domain: 'reports', tag: 'read', description: 'HS component subs' },
  ...
  { name: 'ORWSR GET SURG CONTEXT', domain: 'surgery', tag: 'read', description: 'Get surgery context' },
  ...
  { name: 'ORWSR SAVE SURG CONTEXT', domain: 'surgery', tag: 'write', description: 'Save surgery context' },
  { name: 'ORWSR SHOW OPTOP WHEN SIGNING', domain: 'surgery', tag: 'read', description: 'Show optop when signing' },
...
export const RPC_EXCEPTIONS: Array<{ name: string; reason: string }> = [
  ...
  { name: 'ORWDLR32 ABBSPEC', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 ALLSAMP', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 ALLSPEC', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 DEF', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 GET LAB TIMES', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 IC DEFAULT', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 IC VALID', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 IMMED COLLECT', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 LAB COLL TIME', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 LOAD', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 MAXDAYS', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 ONE SAMPLE', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 ONE SPECIMEN', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR32 STOP', reason: 'Lab order dialog; ORWDLR32 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR33 FUTURE LAB COLLECTS', reason: 'Lab collects; ORWDLR33 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR33 LASTTIME', reason: 'Lab collects; ORWDLR33 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWDLR33 LC TO WC', reason: 'Lab collects; ORWDLR33 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR ALLTESTS', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR ATESTS', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR ATG', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR ATOMICS', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR CHEMTEST', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR GRID', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR INFO', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR INTERIMS', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR NEWOLD', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR PARAM', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR SPEC', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR TG', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR USERS', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR UTGA', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR UTGD', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWLRR UTGR', reason: 'Lab results; ORWLRR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP COLUMN HEADERS', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP GET DEFAULT PRINTER', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP LAB REPORT LISTS', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP PRINT LAB REMOTE', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP PRINT LAB REPORTS', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP PRINT REMOTE REPORT', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP PRINT REPORT', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP PRINT V REPORT', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP PRINT WINDOWS LAB REMOTE', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP PRINT WINDOWS REMOTE', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP PRINT WINDOWS REPORT', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP SAVE DEFAULT PRINTER', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP WINPRINT DEFAULT', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP WINPRINT LAB REPORTS', reason: 'Reports; ORWRP family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP1 LISTNUTR', reason: 'Reports; ORWRP1 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP2 COMPABV', reason: 'Reports; ORWRP2 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP2 COMPDISP', reason: 'Reports; ORWRP2 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP2 GETLKUP', reason: 'Reports; ORWRP2 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP2 HS COMP FILES', reason: 'Reports; ORWRP2 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP2 HS COMPONENT SUBS', reason: 'Reports; ORWRP2 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP2 HS COMPONENTS', reason: 'Reports; ORWRP2 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP2 HS FILE LOOKUP', reason: 'Reports; ORWRP2 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP2 HS REPORT TEXT', reason: 'Reports; ORWRP2 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP2 HS SUBITEMS', reason: 'Reports; ORWRP2 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP2 SAVLKUP', reason: 'Reports; ORWRP2 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP3 EXPAND COLUMNS', reason: 'Reports; ORWRP3 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWRP4 HDR MODIFY', reason: 'Reports; ORWRP4 family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWSR CASELIST', reason: 'Surgery; ORWSR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWSR GET SURG CONTEXT', reason: 'Surgery; ORWSR family underrepresented in Vivian (Phase 580)' },
  ...
  { name: 'ORWSR SAVE SURG CONTEXT', reason: 'Surgery; ORWSR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWSR SHOW OPTOP WHEN SIGNING', reason: 'Surgery; ORWSR family underrepresented in Vivian (Phase 580)' },
  { name: 'ORWSR SHOW SURG TAB', reason: 'Surgery; ORWSR family underrepresented in Vivian (Phase 580)' },
