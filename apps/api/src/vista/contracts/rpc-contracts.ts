...
export const RPC_CONTRACTS: RpcContract[] = [
  // --- Auth ---
  {
    ...
    sanitizeFields: [
      { pattern: "^.*$", action: "replace", replaceWith: "REDACTED-SERVER-INFO" },
    ],
    failureCases: [
      { name: "timeout", description: "VistA unreachable", type: "timeout" },
      { name: "empty", description: "Empty response from VistA", type: "empty", fixtureContent: [] },
    ],
  },
  // --- Patients ---
  {
  ...
  // --- Allergies ---
  {
    ...
    failureCases: [
      { name: "empty", description: "Patient with no allergies", type: "empty", fixtureContent: [] },
      { name: "error-string", description: "Invalid DFN", type: "error-string", fixtureContent: ["ERROR: Invalid patient"] },
    ],
  },
  // --- Vitals ---
  {
  ...
  // --- Medications ---
  {
    ...
    failureCases: [
      ...
      { name: "malformed", description: "Missing ~ delimiters", type: "malformed", fixtureContent: ["BAD DATA"] },
    ],
  },
  // --- Problems ---
  {
  ...
  // --- Default Patient List ---
  {
    ...
    sanitizeFields: [],
    failureCases: [
      { name: "empty", description: "No default list configured", type: "empty", fixtureContent: [""] },
    ],
  },
];
