...
describe("filterObservations", () => {
  const observations = [
    { resourceType: "Observation", code: { coding: [{ code: "8310-5", display: "Body temperature" }] }, effectiveDateTime: "2024-06-15" },
    { resourceType: "Observation", code: { coding: [{ code: "8867-4", display: "Heart rate" }] }, effectiveDateTime: "2024-06-16" },
    { resourceType: "Observation", code: { coding: [{ code: "2160-0", display: "Creatinine" }] }, effectiveDateTime: "2024-07-01" },
  ] as any[];
