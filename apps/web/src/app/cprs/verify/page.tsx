...
const CHECKS: { id: string; label: string; fn: () => Promise<{ ok: boolean; detail: string }> }[] = [
  ...
  },
  {
    ...
    fn: async () => {
      const r = await fetch(`${API_BASE}/vista/ping`);
      const d = await r.json();
  ...
  },
  {
    ...
    fn: async () => {
      const r = await fetch(`${API_BASE}/vista/patient-search?q=CARTER`);
      const d = await r.json();
  ...
  },
  {
    ...
    fn: async () => {
      const r = await fetch(`${API_BASE}/vista/patient-demographics?dfn=1`);
      const d = await r.json();
  ...
  },
  {
    ...
    fn: async () => {
      const r = await fetch(`${API_BASE}/vista/allergies?dfn=1`);
      const d = await r.json();
  ...
  },
  {
    ...
    fn: async () => {
      const r = await fetch(`${API_BASE}/vista/vitals?dfn=1`);
      const d = await r.json();
  ...
  },
  {
    ...
    fn: async () => {
      const r = await fetch(`${API_BASE}/vista/notes?dfn=1`);
      const d = await r.json();
  ...
  },
  {
    ...
    fn: async () => {
      const r = await fetch(`${API_BASE}/vista/medications?dfn=1`);
      const d = await r.json();
  ...
  },
  {
    ...
    fn: async () => {
      const r = await fetch(`${API_BASE}/vista/problems?dfn=1`);
      const d = await r.json();
