    ...
    <div className={styles.shell}>
      ...
      <div style={{ padding: 16 }}>
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 12, color: 'var(--cprs-text-muted)', margin: '4px 0 0' }}>
              {user?.userName || 'Provider'} &bull; {pendingCount} pending item
              {pendingCount !== 1 ? 's' : ''}
            </p>
          </div>
        ...
        >
          ...
          ORWORB UNSIG ORDERS (unsigned orders), and cross-references lab/consult domains. In the
          Docker sandbox, notification counts depend on the test data state.
        </div>
      </div>
    </div>
  );
