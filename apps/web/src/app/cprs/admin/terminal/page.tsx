...
const BrowserTerminal = dynamic(
  () => import("../../../../components/terminal/BrowserTerminal"),
  { ssr: false, loading: () => <div style={{ color: "#94a3b8", padding: 24 }}>Loading terminal...</div> }
);
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1200, margin: "0 auto", color: "#e2e8f0" }}>
      ...
      >
        ...
        <code style={{ background: "#1e293b", padding: "2px 6px", borderRadius: 4, margin: "0 4px" }}>
          XUS AV CODE
        </code>
        and
        <code style={{ background: "#1e293b", padding: "2px 6px", borderRadius: 4, margin: "0 4px" }}>
        ...
        RPCs to prevent credential theft or privilege escalation through this console.
        All commands are logged to the immutable audit trail.
      </div>
