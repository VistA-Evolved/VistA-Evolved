...
const ADMIN_NAV: AdminNavItem[] = [
  ...
  { label: 'Adapter Health', href: '/cprs/admin/adapters' },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const matchingItem = ADMIN_NAV.find(
    (item) =>
      item.moduleId && pathname && (pathname === item.href || pathname.startsWith(item.href + '/'))
  );
  const isBlockedModule =
    matchingItem?.moduleId && tenant && !isModuleEnabled(matchingItem.moduleId);
        ...
        {isBlockedModule ? (
          ...
          >
            ...
            >
              ...
              >
                <strong>{blockedModuleName}</strong> is not enabled for your facility. Contact your
                system administrator to enable this module.
              </p>
              <Link
