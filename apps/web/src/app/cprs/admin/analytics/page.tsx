  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 20, fontWeight: 600 }}>
        {value}
        {unit && <span style={{ fontSize: 12, color: '#999', marginLeft: 2 }}>{unit}</span>}
      </div>
    </div>
  );
}
...
export default function AnalyticsPage() {
  ...
  return (
    <div
      style={{ padding: 24, fontFamily: 'system-ui, sans-serif', maxWidth: 1200, margin: '0 auto' }}
    >
      ...
      {tab === 'ops' && opsDash && !loading && (
        <div>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 16 }}>
            ...
            <MetricCard
              label="Buffer Usage"
              value={`${Math.round(opsDash.analytics.eventBuffer.bufferUsage * 100)}%`}
            />
            <MetricCard
              label="Hourly Buckets"
              value={opsDash.analytics.aggregation.hourlyBuckets}
            />
          ...
          {opsDash.analytics.eventBuffer.categories && (
            <div style={{ marginTop: 16 }}>
              ...
              <table
                style={{ borderCollapse: 'collapse', fontSize: 13, width: '100%', maxWidth: 500 }}
              >
                <thead>
      ...
      {tab === 'clinical' && clinicalDash && !loading && (
        <div>
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 20 }}>
            ...
            <MetricCard
              label="Avg Latency"
              value={clinicalDash.clinicalReports.avgLatency}
              unit="ms"
            />
            <MetricCard label="Recent Orders" value={clinicalDash.orderActivity.recentOrders} />
            <MetricCard
              label="Recent Searches"
              value={clinicalDash.searchActivity.recentSearches}
            />
          </div>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 16 }}>
            <MetricCard
              label="List Cache"
              value={clinicalDash.clinicalReports.cacheHealth.listCacheSize}
            />
            <MetricCard
              label="Text Cache"
              value={clinicalDash.clinicalReports.cacheHealth.textCacheSize}
            />
            <MetricCard
              label="Cache TTL"
              value={clinicalDash.clinicalReports.cacheHealth.cacheTtlMs}
              unit="ms"
            />
          </div>
            ...
            <tbody>
              <tr style={{ borderBottom: '1px solid #f5f5f5' }}>
                ...
                <td style={{ padding: '4px 8px', textAlign: 'right' }}>
                  {clinicalDash.clinicalReports.dailyBuckets}
                </td>
                <td style={{ padding: '4px 8px', textAlign: 'right' }}>
                  {clinicalDash.clinicalReports.recentViews}
                </td>
              </tr>
              <tr style={{ borderBottom: '1px solid #f5f5f5' }}>
                <td style={{ padding: '4px 8px' }}>Orders</td>
                <td style={{ padding: '4px 8px', textAlign: 'right' }}>
                  {clinicalDash.orderActivity.dailyBuckets}
                </td>
                <td style={{ padding: '4px 8px', textAlign: 'right' }}>
                  {clinicalDash.orderActivity.recentOrders}
                </td>
              </tr>
              <tr style={{ borderBottom: '1px solid #f5f5f5' }}>
                <td style={{ padding: '4px 8px' }}>Searches</td>
                <td style={{ padding: '4px 8px', textAlign: 'right' }}>
                  {clinicalDash.searchActivity.dailyBuckets}
                </td>
                <td style={{ padding: '4px 8px', textAlign: 'right' }}>
                  {clinicalDash.searchActivity.recentSearches}
                </td>
              </tr>
            </tbody>
          </table>
          ...
          {health && (
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 16 }}>
                ...
                <MetricCard
                  label="Buffer Usage"
                  value={`${Math.round(health.eventBuffer.bufferUsage * 100)}%`}
                />
