        ...
        <div>
          <div style={{
            ...
            <div style={{ padding: 16, border: "1px solid #e5e7eb", borderRadius: 8, textAlign: "center" }}>
              <div style={{ fontSize: 36, fontWeight: 700, color: scoreColor(overview.overallScore) }}>
                {overview.overallScore}%
              </div>
              <div style={{ color: "#6b7280", fontSize: 14 }}>Overall Score</div>
            </div>
            <div style={{ padding: 16, border: "1px solid #e5e7eb", borderRadius: 8, textAlign: "center" }}>
              <div style={{ fontSize: 36, fontWeight: 700 }}>{overview.passingGates}/{overview.totalGates}</div>
      ...
      {tab === "stores" && stores && (
        <div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginBottom: 24 }}>
            ...
            <div style={{ padding: 16, border: "1px solid #e5e7eb", borderRadius: 8, textAlign: "center" }}>
              <div style={{ fontSize: 28, fontWeight: 700, color: stores.criticalInMemory > 20 ? "#ef4444" : "#22c55e" }}>
                {stores.criticalInMemory}
              </div>
              <div style={{ color: "#6b7280", fontSize: 14 }}>Critical In-Memory</div>
            </div>
            <div style={{ padding: 16, border: "1px solid #e5e7eb", borderRadius: 8, textAlign: "center" }}>
              <div style={{ fontSize: 28, fontWeight: 700 }}>{Object.keys(stores.byDomain).length}</div>
        ...
        <div>
          ...
          {Object.entries(
            ...
            <div key={domain} style={{ marginBottom: 16 }}>
              <h3 style={{ fontSize: 16, fontWeight: 600, textTransform: "capitalize", marginBottom: 8 }}>
                {domain} ({rbs.length})
              </h3>
              {rbs.map((rb) => (
                <div key={rb.name} style={{
                  padding: 8, borderBottom: "1px solid #f3f4f6", fontSize: 14,
                }}>
                  ...
                  <a
                    ...
                    style={{ color: "#2563eb", marginLeft: 8, textDecoration: "underline", fontSize: 12 }}
                  >
                    {rb.path}
                  </a>
                </div>
