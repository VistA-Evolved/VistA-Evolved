  ...
  return (
    <div style={{ padding: '1rem' }}>
      <h2 style={{ fontSize: '1.25rem', marginBottom: '0.5rem' }}>
        Longitudinal Viewer
        <span style={{ fontSize: '0.7rem', marginLeft: '0.5rem', color: '#0d6efd' }}>
          Phase 540 - JLV v1
        </span>
      </h2>
      ...
      {error && (
        <div style={{ color: '#dc3545', marginBottom: '0.5rem', fontSize: '0.85rem' }}>{error}</div>
      )}
            ...
            <div style={{ maxHeight: 500, overflowY: 'auto' }}>
              {events.slice(0, 200).map((ev: any, i: number) => (
                ...
                >
                  ...
                  <span
                    style={{ fontSize: '0.75rem', color: '#6c757d', minWidth: 80, flexShrink: 0 }}
                  >
                    {ev.date || 'undated'}
                  </span>
                  <div style={{ flex: 1 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.75rem' }}>
            {summary.map((s: any) => (
              ...
              >
                ...
                <div style={{ fontSize: '0.8rem', color: '#495057', textTransform: 'capitalize' }}>
                  {s.domain}
                </div>
                <div style={{ fontSize: '0.65rem', color: '#6c757d', marginTop: '0.25rem' }}>
                  {s.rpc}
                </div>
              </div>
            ))}
