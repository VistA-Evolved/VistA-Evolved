...
export const ACTION_REGISTRY: CprsAction[] = [
  ...
  {
    actionId: 'cover.load-immunizations',
    label: 'Load Immunizations',
    location: 'CoverSheet',
  ...
  },
  {
    ...
    rpcs: ['SDOE LIST ENCOUNTERS FOR PAT'],
    status: 'wired',
    pendingNote:
      'Falls back to request-only posture when the scheduling adapter cannot read VistA encounters.',
  ...
  },
  {
    ...
    rpcs: ['VE PROBLEM ADD', 'ORQQPL ADD SAVE'],
    status: 'wired',
  ...
  {
    actionId: 'labs.order',
    label: 'Submit Lab Order',
    location: 'Labs',
    capability: 'clinical.labs.write',
    rpcs: ['ORWDX LOCK', 'ORWDXM AUTOACK', 'ORWDX UNLOCK'],
    status: 'wired',
    endpoint: '/vista/cprs/orders/lab',
    rpcKind: 'write',
  },
  ...
  },
  {
    ...
    rpcKind: 'read',
    pendingNote:
      'Tasks are truthfully derived from active VistA medications today. BCMA-specific task timing still requires PSB MED LOG in production.',
  },
  {
    ...
    rpcs: ['ORWPS ACTIVE', 'ORWORR GETTXT'],
    status: 'wired',
    endpoint: '/emar/schedule',
    rpcKind: 'read',
    pendingNote:
      'The chart MAR tab is backed by the shared eMAR schedule/history fallback. Real BCMA timestamps still require PSB MED LOG in production.',
  },
  {
    ...
    rpcs: ['TIU CREATE RECORD', 'TIU SET DOCUMENT TEXT'],
    status: 'wired',
    endpoint: '/emar/administer',
    rpcKind: 'write',
    pendingNote:
      'Fallback administration capture is wired through TIU nursing notes. PSB MED LOG remains the production BCMA target.',
  },
];
