...
- **Total endpoints:** 1202
- **By tag:** vista(539), rcm(348), other(92), admin(82), portal(79), infra(60), imaging(20), analytics(14), scheduling(14), telehealth(13), interop(10), iam(9), posture(5), auth(3)
