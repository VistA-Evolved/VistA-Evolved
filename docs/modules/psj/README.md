...
**API Endpoint:** `GET /vista/psj/rpc/psoerxa0-drgmtch`
...
**API Endpoint:** `GET /vista/psj/rpc/psoerxa0-prvmtch`
...
**API Endpoint:** `GET /vista/psj/rpc/psoerxa1-incerx`
...
**API Endpoint:** `GET /vista/psj/rpc/psoerxi1-incerx`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-vcc-refill`
...
**API Endpoint:** `GET /vista/psj/rpc/psorpc`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-edit`
...
**API Endpoint:** `POST /vista/psj/rpc/pso-epcs-add-dea`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-deadoj`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-mbm`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-remove-dea`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-dea-dup-check`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-dealist`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-version`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-detox-check`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-va#-dup-check`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-filer`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-reports`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-system-date-time`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-field-help`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-get-list`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-list-np-sched`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-file-np-sched`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-list-optn-desc`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-topic-help`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-activity-log`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-cmop-log`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-copay-log`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-ecme-log`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-erx-log`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-label-log`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-lot-expiration`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-partials-log`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-refill-log`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-cred`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-epcs-psdrph-filer`
...
**API Endpoint:** `POST /vista/psj/rpc/pso-address-update`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-get-address`
...
**API Endpoint:** `POST /vista/psj/rpc/pso-temp-address-active-flag`
...
**API Endpoint:** `GET /vista/psj/rpc/pso-del-temporary-address`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-scanpt`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-instructor`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-userload`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-usersave`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-fmdate`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-scanmed`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-parameter`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-transaction`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-validate-order`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-server-clock-variance`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-medication-history`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-getprns`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-report`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-submit-missing-dose`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-validate-esig`
...
**API Endpoint:** `POST /vista/psj/rpc/psb-lock`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-check-server`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-mail`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-getordertab`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-wardlist`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-getivpar`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-device`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-putivpar`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-iv-order-history`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-bag-detail`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-allergy`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-getprovider`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-mob-drug-list`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-cprs-order`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-nurs-wardlist`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-maxdays`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-version-check`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-check-iv`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-vitals`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-vital-meas-file`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-med-log-lookup`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-coversheet1`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-utl-xstatus-srch`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-man-scan-failure`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-getinjectionsite`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-witness`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-cliniclist`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-meds-on-patient`
...
**API Endpoint:** `GET /vista/psj/rpc/psb-getsetwp`
...
**API Endpoint:** `GET /vista/psj/rpc/psn-fda-med-guide-print-queue`
...
**API Endpoint:** `GET /vista/psj/rpc/psa-upload`
...
| PSJ PADE MAIN MENU | — |
| PSJ PADE INVENTORY MENU | PSJ PADE MGR |
...
| Name | Security Key |
|------|-------------|
| PSJ PADE SETUP | PSJ PADE MGR |
| PSJ PADE INVENTORY SYSTEM | PSJ PADE MGR |
| PSJ PADE SEND AREA SETUP | PSJ PADE MGR |
| PSJ PADE SURGERY TASK | — |
| PSJ PADE SEND SURGERY CASES | — |
| PSJ PADE DEVICE SETUP | PSJ PADE MGR |
| PSJ PADE SEND ORDERS | — |
| PSJ PADE DIVISION SETUP | PSJ PADE ADV |
| PSJ PADE APPOINTMENT TASK | — |
...
All routes are prefixed with `/vista/psj/`.

| Method | Endpoint | RPC | Return Type |
|--------|----------|-----|-------------|
| GET | `/vista/psj/rpc/psoerxa0-drgmtch` | PSOERXA0 DRGMTCH | SINGLE VALUE |
| GET | `/vista/psj/rpc/psoerxa0-prvmtch` | PSOERXA0 PRVMTCH | SINGLE VALUE |
| GET | `/vista/psj/rpc/psoerxa1-incerx` | PSOERXA1 INCERX | SINGLE VALUE |
| GET | `/vista/psj/rpc/psoerxi1-incerx` | PSOERXI1 INCERX | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-vcc-refill` | PSO VCC REFILL | ARRAY |
| GET | `/vista/psj/rpc/psorpc` | PSORPC | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/pso-epcs-edit` | PSO EPCS EDIT | SINGLE VALUE |
| POST | `/vista/psj/rpc/pso-epcs-add-dea` | PSO EPCS ADD DEA | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-deadoj` | PSO EPCS DEADOJ | ARRAY |
| GET | `/vista/psj/rpc/pso-epcs-mbm` | PSO EPCS MBM | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-remove-dea` | PSO EPCS REMOVE DEA | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-dea-dup-check` | PSO EPCS DEA DUP CHECK | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-dealist` | PSO EPCS DEALIST | ARRAY |
| GET | `/vista/psj/rpc/pso-epcs-version` | PSO EPCS VERSION | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-detox-check` | PSO EPCS DETOX CHECK | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-va#-dup-check` | PSO EPCS VA# DUP CHECK | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-filer` | PSO EPCS FILER | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-reports` | PSO EPCS REPORTS | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/pso-epcs-system-date-time` | PSO EPCS SYSTEM DATE TIME | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-field-help` | PSO EPCS FIELD HELP | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-get-list` | PSO EPCS GET LIST | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/pso-epcs-list-np-sched` | PSO EPCS LIST NP SCHED | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-file-np-sched` | PSO EPCS FILE NP SCHED | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-list-optn-desc` | PSO EPCS LIST OPTN DESC | ARRAY |
| GET | `/vista/psj/rpc/pso-epcs-topic-help` | PSO EPCS TOPIC HELP | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/pso-activity-log` | PSO ACTIVITY LOG | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-cmop-log` | PSO CMOP LOG | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-copay-log` | PSO COPAY LOG | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-ecme-log` | PSO ECME LOG | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-erx-log` | PSO ERX LOG | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-label-log` | PSO LABEL LOG | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-lot-expiration` | PSO LOT EXPIRATION | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-partials-log` | PSO PARTIALS LOG | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-refill-log` | PSO REFILL LOG | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-cred` | PSO EPCS CRED | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-epcs-psdrph-filer` | PSO EPCS PSDRPH FILER | SINGLE VALUE |
| POST | `/vista/psj/rpc/pso-address-update` | PSO ADDRESS UPDATE | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-get-address` | PSO GET ADDRESS | SINGLE VALUE |
| POST | `/vista/psj/rpc/pso-temp-address-active-flag` | PSO TEMP ADDRESS ACTIVE FLAG | SINGLE VALUE |
| GET | `/vista/psj/rpc/pso-del-temporary-address` | PSO DEL TEMPORARY ADDRESS | SINGLE VALUE |
| GET | `/vista/psj/rpc/psb-scanpt` | PSB SCANPT | ARRAY |
| GET | `/vista/psj/rpc/psb-instructor` | PSB INSTRUCTOR | ARRAY |
| GET | `/vista/psj/rpc/psb-userload` | PSB USERLOAD | ARRAY |
| GET | `/vista/psj/rpc/psb-usersave` | PSB USERSAVE | ARRAY |
| GET | `/vista/psj/rpc/psb-fmdate` | PSB FMDATE | ARRAY |
| GET | `/vista/psj/rpc/psb-scanmed` | PSB SCANMED | ARRAY |
| GET | `/vista/psj/rpc/psb-parameter` | PSB PARAMETER | ARRAY |
| GET | `/vista/psj/rpc/psb-transaction` | PSB TRANSACTION | ARRAY |
| GET | `/vista/psj/rpc/psb-validate-order` | PSB VALIDATE ORDER | ARRAY |
| GET | `/vista/psj/rpc/psb-server-clock-variance` | PSB SERVER CLOCK VARIANCE | ARRAY |
| GET | `/vista/psj/rpc/psb-medication-history` | PSB MEDICATION HISTORY | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psb-getprns` | PSB GETPRNS | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psb-report` | PSB REPORT | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psb-submit-missing-dose` | PSB SUBMIT MISSING DOSE | ARRAY |
| GET | `/vista/psj/rpc/psb-validate-esig` | PSB VALIDATE ESIG | ARRAY |
| POST | `/vista/psj/rpc/psb-lock` | PSB LOCK | ARRAY |
| GET | `/vista/psj/rpc/psb-check-server` | PSB CHECK SERVER | ARRAY |
| GET | `/vista/psj/rpc/psb-mail` | PSB MAIL | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psb-getordertab` | PSB GETORDERTAB | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psb-wardlist` | PSB WARDLIST | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psb-getivpar` | PSB GETIVPAR | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psb-device` | PSB DEVICE | ARRAY |
| GET | `/vista/psj/rpc/psb-putivpar` | PSB PUTIVPAR | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psb-iv-order-history` | PSB IV ORDER HISTORY | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psb-bag-detail` | PSB BAG DETAIL | ARRAY |
| GET | `/vista/psj/rpc/psb-allergy` | PSB ALLERGY | ARRAY |
| GET | `/vista/psj/rpc/psb-getprovider` | PSB GETPROVIDER | ARRAY |
| GET | `/vista/psj/rpc/psb-mob-drug-list` | PSB MOB DRUG LIST | ARRAY |
| GET | `/vista/psj/rpc/psb-cprs-order` | PSB CPRS ORDER | ARRAY |
| GET | `/vista/psj/rpc/psb-nurs-wardlist` | PSB NURS WARDLIST | ARRAY |
| GET | `/vista/psj/rpc/psb-maxdays` | PSB MAXDAYS | ARRAY |
| GET | `/vista/psj/rpc/psb-version-check` | PSB VERSION CHECK | ARRAY |
| GET | `/vista/psj/rpc/psb-check-iv` | PSB CHECK IV | ARRAY |
| GET | `/vista/psj/rpc/psb-vitals` | PSB VITALS | ARRAY |
| GET | `/vista/psj/rpc/psb-vital-meas-file` | PSB VITAL MEAS FILE | ARRAY |
| GET | `/vista/psj/rpc/psb-med-log-lookup` | PSB MED LOG LOOKUP | ARRAY |
| GET | `/vista/psj/rpc/psb-coversheet1` | PSB COVERSHEET1 | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psb-utl-xstatus-srch` | PSB UTL XSTATUS SRCH | ARRAY |
| GET | `/vista/psj/rpc/psb-man-scan-failure` | PSB MAN SCAN FAILURE | ARRAY |
| GET | `/vista/psj/rpc/psb-getinjectionsite` | PSB GETINJECTIONSITE | ARRAY |
| GET | `/vista/psj/rpc/psb-witness` | PSB WITNESS | ARRAY |
| GET | `/vista/psj/rpc/psb-cliniclist` | PSB CLINICLIST | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psb-meds-on-patient` | PSB MEDS ON PATIENT | ARRAY |
| GET | `/vista/psj/rpc/psb-getsetwp` | PSB GETSETWP | GLOBAL ARRAY |
| GET | `/vista/psj/rpc/psn-fda-med-guide-print-queue` | PSN FDA MED GUIDE PRINT QUEUE | ARRAY |
| GET | `/vista/psj/rpc/psa-upload` | PSA UPLOAD | ARRAY |
