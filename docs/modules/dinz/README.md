...
**API Endpoint:** `GET /vista/dinz/rpc/ddr-gets-entry-data`
...
**API Endpoint:** `GET /vista/dinz/rpc/ddr-lister`
...
**API Endpoint:** `GET /vista/dinz/rpc/ddr-filer`
...
**API Endpoint:** `GET /vista/dinz/rpc/ddr-validator`
...
**API Endpoint:** `POST /vista/dinz/rpc/ddr-delete-entry`
...
**API Endpoint:** `POST /vista/dinz/rpc/ddr-lock/unlock-node`
...
**API Endpoint:** `GET /vista/dinz/rpc/ddr-find1`
...
**API Endpoint:** `GET /vista/dinz/rpc/ddr-get-dd-help`
...
**API Endpoint:** `GET /vista/dinz/rpc/ddr-finder`
...
**API Endpoint:** `GET /vista/dinz/rpc/ddr-key-validator`
...
All routes are prefixed with `/vista/dinz/`.

| Method | Endpoint | RPC | Return Type |
|--------|----------|-----|-------------|
| GET | `/vista/dinz/rpc/ddr-gets-entry-data` | DDR GETS ENTRY DATA | ARRAY |
| GET | `/vista/dinz/rpc/ddr-lister` | DDR LISTER | GLOBAL ARRAY |
| GET | `/vista/dinz/rpc/ddr-filer` | DDR FILER | ARRAY |
| GET | `/vista/dinz/rpc/ddr-validator` | DDR VALIDATOR | ARRAY |
| POST | `/vista/dinz/rpc/ddr-delete-entry` | DDR DELETE ENTRY | SINGLE VALUE |
| POST | `/vista/dinz/rpc/ddr-lock/unlock-node` | DDR LOCK/UNLOCK NODE | SINGLE VALUE |
| GET | `/vista/dinz/rpc/ddr-find1` | DDR FIND1 | ARRAY |
| GET | `/vista/dinz/rpc/ddr-get-dd-help` | DDR GET DD HELP | ARRAY |
| GET | `/vista/dinz/rpc/ddr-finder` | DDR FINDER | GLOBAL ARRAY |
| GET | `/vista/dinz/rpc/ddr-key-validator` | DDR KEY VALIDATOR | ARRAY |
