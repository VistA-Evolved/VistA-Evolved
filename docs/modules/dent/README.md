...
**API Endpoint:** `GET /vista/dent/rpc/dentv-ada-codes-quick`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-add-ql-entry`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-dd-field-update`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-dd-get-data`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-dd-get/add-record`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-dd-security-key`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-delete-history-entry`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-delete-ql-entry`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-dent-history-enc`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-dental-classifications`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-excel-extract`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-file-admin-time`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-file-data`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-categ/codes`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-categories`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-code-list`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tooth-history`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-dental-provider`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-mult-param`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-inpatient-bedsection`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-fee-basis-add`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-fee-basis-list`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-file-psr`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-file-perio`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-file-hnc`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-tp-add-encounter`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-get-ada-table`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-get-providers`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-file-tooth-note`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-get-tooth-notes`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-get-hnc`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-get-psr`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-get-perio`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-file-transactions`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-delete-transactions`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-get-transactions`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-report-providers`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-report-data`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-all-providers`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-provider-types`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-provider-specialties`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-provider-add-update`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-new-extract`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-get-old-encounters`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-file-parameters`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-file-reserved-txns`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-get-reserved-txns`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-va-dss-products`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-report-klf`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-primary-provider`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-ada-get-costs`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-coding-guidelines`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-alerts`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-patient-provider`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-active-user-provider`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-cover-page-info`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-get-last-status`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-code-checks`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-update-pce`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-update-pce-dx`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-monitor-queue`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-monitor-poll`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-delete-unfiled-data`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-unfiled-detail`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-clean-slate`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-file-exam-transaction`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-get-exam-transactions`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-clean-slate-list`
...
**API Endpoint:** `POST /vista/dent/rpc/dentv-update-comment-sort`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-get-canned-comments`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-file-canned-comments`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-del-canned-comment`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-person-class-inquiry`
...
**API Endpoint:** `GET /vista/dent/rpc/dentv-tp-reserved-inact-check`
...
**API Endpoint:** `GET /vista/dent/rpc/dentvx2-getwp`
...
**API Endpoint:** `GET /vista/dent/rpc/dentvx2-filewp`
...
**API Endpoint:** `GET /vista/dent/rpc/dentvgui-version-get`
...
**API Endpoint:** `GET /vista/dent/rpc/dentvicd-acticd`
...
**API Endpoint:** `GET /vista/dent/rpc/dentvicd-icd-get-diag`
...
**API Endpoint:** `GET /vista/dent/rpc/dentvicd-list`
...
**API Endpoint:** `GET /vista/dent/rpc/dentvicd-icd10-activation-date`
...
| DENT AMIS REPORTS | — |
| DENT PROGMAN | — |
| DENT SERVICE REPORTS | — |
| DENT GECS MAINTENANCE USER MEN | — |
| DENT GECS REPORTS MENU | — |
| DENT GECS USER MENU | — |
| DENT GECS TRANSMIT USER | — |
| DENT GECS MAIN MENU | — |
...
|------|-------------|
| DENT GECS BATCH | — |
| DENT GECS BATCH EDIT | — |
| DENT GECS BATCHES STATUS | — |
| DENT GECS BATCHES WAITING TRAN | — |
| DENT GECS CODE EDIT | — |
| DENT GECS CREATE | — |
| DENT GECS DELETE | — |
| DENT GECS KEYPUNCH | — |
| DENT GECS PURGE | — |
| DENT GECS READY FOR BATCHING L | — |
| DENT GECS REBATCH | — |
| DENT GECS RETRANSMIT | — |
| DENT GECS REVIEW CODE SHEET | — |
| DENT GECS TRANSMIT | — |
...
All routes are prefixed with `/vista/dent/`.

| Method | Endpoint | RPC | Return Type |
|--------|----------|-----|-------------|
| GET | `/vista/dent/rpc/dentv-ada-codes-quick` | DENTV ADA CODES QUICK | GLOBAL ARRAY |
| POST | `/vista/dent/rpc/dentv-add-ql-entry` | DENTV ADD QL ENTRY | SINGLE VALUE |
| POST | `/vista/dent/rpc/dentv-dd-field-update` | DENTV DD FIELD UPDATE | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-dd-get-data` | DENTV DD GET DATA | ARRAY |
| POST | `/vista/dent/rpc/dentv-dd-get/add-record` | DENTV DD GET/ADD RECORD | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-dd-security-key` | DENTV DD SECURITY KEY | SINGLE VALUE |
| POST | `/vista/dent/rpc/dentv-delete-history-entry` | DENTV DELETE HISTORY ENTRY | SINGLE VALUE |
| POST | `/vista/dent/rpc/dentv-delete-ql-entry` | DENTV DELETE QL ENTRY | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-dent-history-enc` | DENTV DENT HISTORY ENC | ARRAY |
| GET | `/vista/dent/rpc/dentv-dental-classifications` | DENTV DENTAL CLASSIFICATIONS | ARRAY |
| GET | `/vista/dent/rpc/dentv-excel-extract` | DENTV EXCEL EXTRACT | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-file-admin-time` | DENTV FILE ADMIN TIME | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-file-data` | DENTV FILE DATA | ARRAY |
| GET | `/vista/dent/rpc/dentv-get-categ/codes` | DENTV GET CATEG/CODES | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-get-categories` | DENTV GET CATEGORIES | ARRAY |
| GET | `/vista/dent/rpc/dentv-get-code-list` | DENTV GET CODE LIST | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-tooth-history` | DENTV TOOTH HISTORY | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-dental-provider` | DENTV DENTAL PROVIDER | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-mult-param` | DENTV MULT PARAM | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-inpatient-bedsection` | DENTV INPATIENT BEDSECTION | SINGLE VALUE |
| POST | `/vista/dent/rpc/dentv-fee-basis-add` | DENTV FEE BASIS ADD | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-fee-basis-list` | DENTV FEE BASIS LIST | ARRAY |
| GET | `/vista/dent/rpc/dentv-tp-file-psr` | DENTV TP FILE PSR | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-tp-file-perio` | DENTV TP FILE PERIO | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-tp-file-hnc` | DENTV TP FILE HNC | ARRAY |
| POST | `/vista/dent/rpc/dentv-tp-add-encounter` | DENTV TP ADD ENCOUNTER | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-tp-get-ada-table` | DENTV TP GET ADA TABLE | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-tp-get-providers` | DENTV TP GET PROVIDERS | ARRAY |
| GET | `/vista/dent/rpc/dentv-tp-file-tooth-note` | DENTV TP FILE TOOTH NOTE | ARRAY |
| GET | `/vista/dent/rpc/dentv-tp-get-tooth-notes` | DENTV TP GET TOOTH NOTES | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-tp-get-hnc` | DENTV TP GET HNC | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-tp-get-psr` | DENTV TP GET PSR | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-tp-get-perio` | DENTV TP GET PERIO | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-tp-file-transactions` | DENTV TP FILE TRANSACTIONS | ARRAY |
| POST | `/vista/dent/rpc/dentv-delete-transactions` | DENTV DELETE TRANSACTIONS | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-tp-get-transactions` | DENTV TP GET TRANSACTIONS | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-report-providers` | DENTV REPORT PROVIDERS | ARRAY |
| GET | `/vista/dent/rpc/dentv-report-data` | DENTV REPORT DATA | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-get-all-providers` | DENTV GET ALL PROVIDERS | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-get-provider-types` | DENTV GET PROVIDER TYPES | ARRAY |
| GET | `/vista/dent/rpc/dentv-get-provider-specialties` | DENTV GET PROVIDER SPECIALTIES | ARRAY |
| POST | `/vista/dent/rpc/dentv-provider-add-update` | DENTV PROVIDER ADD UPDATE | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-new-extract` | DENTV NEW EXTRACT | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-tp-get-old-encounters` | DENTV TP GET OLD ENCOUNTERS | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-file-parameters` | DENTV FILE PARAMETERS | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-tp-file-reserved-txns` | DENTV TP FILE RESERVED TXNS | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-tp-get-reserved-txns` | DENTV TP GET RESERVED TXNS | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-get-va-dss-products` | DENTV GET VA-DSS PRODUCTS | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-report-klf` | DENTV REPORT KLF | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-primary-provider` | DENTV PRIMARY PROVIDER | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-ada-get-costs` | DENTV ADA GET COSTS | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-get-coding-guidelines` | DENTV GET CODING GUIDELINES | ARRAY |
| GET | `/vista/dent/rpc/dentv-alerts` | DENTV ALERTS | ARRAY |
| GET | `/vista/dent/rpc/dentv-patient-provider` | DENTV PATIENT PROVIDER | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-active-user-provider` | DENTV ACTIVE USER PROVIDER | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-get-cover-page-info` | DENTV GET COVER PAGE INFO | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-tp-get-last-status` | DENTV TP GET LAST STATUS | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-tp-code-checks` | DENTV TP CODE CHECKS | SINGLE VALUE |
| POST | `/vista/dent/rpc/dentv-update-pce` | DENTV UPDATE PCE | GLOBAL ARRAY |
| POST | `/vista/dent/rpc/dentv-update-pce-dx` | DENTV UPDATE PCE DX | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-monitor-queue` | DENTV MONITOR QUEUE | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-monitor-poll` | DENTV MONITOR POLL | ARRAY |
| POST | `/vista/dent/rpc/dentv-delete-unfiled-data` | DENTV DELETE UNFILED DATA | ARRAY |
| GET | `/vista/dent/rpc/dentv-get-unfiled-detail` | DENTV GET UNFILED DETAIL | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentv-tp-clean-slate` | DENTV TP CLEAN SLATE | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-tp-file-exam-transaction` | DENTV TP FILE EXAM TRANSACTION | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-tp-get-exam-transactions` | DENTV TP GET EXAM TRANSACTIONS | ARRAY |
| GET | `/vista/dent/rpc/dentv-get-clean-slate-list` | DENTV GET CLEAN SLATE LIST | ARRAY |
| POST | `/vista/dent/rpc/dentv-update-comment-sort` | DENTV UPDATE COMMENT SORT | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-get-canned-comments` | DENTV GET CANNED COMMENTS | ARRAY |
| GET | `/vista/dent/rpc/dentv-file-canned-comments` | DENTV FILE CANNED COMMENTS | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-del-canned-comment` | DENTV DEL CANNED COMMENT | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-person-class-inquiry` | DENTV PERSON CLASS INQUIRY | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentv-tp-reserved-inact-check` | DENTV TP RESERVED INACT CHECK | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentvx2-getwp` | DENTVX2 GETWP | ARRAY |
| GET | `/vista/dent/rpc/dentvx2-filewp` | DENTVX2 FILEWP | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentvgui-version-get` | DENTVGUI VERSION GET | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentvicd-acticd` | DENTVICD ACTICD | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentvicd-icd-get-diag` | DENTVICD ICD GET DIAG | SINGLE VALUE |
| GET | `/vista/dent/rpc/dentvicd-list` | DENTVICD LIST | GLOBAL ARRAY |
| GET | `/vista/dent/rpc/dentvicd-icd10-activation-date` | DENTVICD ICD10 ACTIVATION DATE | SINGLE VALUE |
