...
**API Endpoint:** `GET /vista/psn/rpc/psn-fda-med-guide-print-queue`
...
|------|-------------|
| PSN MED GUIDE | — |
| PSN PPS MANUAL DOWNLOAD | PSN PPS ADMIN |
| PSN TASK SCHEDULED DOWNLOAD | — |
| PSN PPS REJECT FILE | PSN PPS ADMIN |
| PSN PPS MANUAL INSTALL | PSN PPS ADMIN |
| PSN PPS SCHEDULE INSTALL | PSN PPS ADMIN |
| PSN PPS SCHEDULE DOWNLOAD | PSN PPS ADMIN |
| PSN PPS PARAM | PSN PPS ADMIN |
| PSN PPS VISTA COMPARISON RPT | — |
| PSN PPS DNLD/INST STATUS REP | — |
| PSN TASK SCHEDULED INSTALL | — |
...
| Name | Security Key |
|------|-------------|
| PSN PPS SSH KEY MANAGEMENT | PSN PPS COORD |

### Menu

| Name | Security Key |
|------|-------------|
| PSN PPS MENU | PSN PPS ADMIN |
...
All routes are prefixed with `/vista/psn/`.

| Method | Endpoint | RPC | Return Type |
|--------|----------|-----|-------------|
| GET | `/vista/psn/rpc/psn-fda-med-guide-print-queue` | PSN FDA MED GUIDE PRINT QUEUE | ARRAY |
