...
**API Endpoint:** `GET /vista/di/rpc/ddr-gets-entry-data`
...
**API Endpoint:** `GET /vista/di/rpc/ddr-lister`
...
**API Endpoint:** `GET /vista/di/rpc/ddr-filer`
...
**API Endpoint:** `GET /vista/di/rpc/ddr-validator`
...
**API Endpoint:** `POST /vista/di/rpc/ddr-delete-entry`
...
**API Endpoint:** `POST /vista/di/rpc/ddr-lock/unlock-node`
...
**API Endpoint:** `GET /vista/di/rpc/ddr-find1`
...
**API Endpoint:** `GET /vista/di/rpc/ddr-get-dd-help`
...
**API Endpoint:** `GET /vista/di/rpc/ddr-finder`
...
**API Endpoint:** `GET /vista/di/rpc/ddr-key-validator`
...
All routes are prefixed with `/vista/di/`.

| Method | Endpoint | RPC | Return Type |
|--------|----------|-----|-------------|
| GET | `/vista/di/rpc/ddr-gets-entry-data` | DDR GETS ENTRY DATA | ARRAY |
| GET | `/vista/di/rpc/ddr-lister` | DDR LISTER | GLOBAL ARRAY |
| GET | `/vista/di/rpc/ddr-filer` | DDR FILER | ARRAY |
| GET | `/vista/di/rpc/ddr-validator` | DDR VALIDATOR | ARRAY |
| POST | `/vista/di/rpc/ddr-delete-entry` | DDR DELETE ENTRY | SINGLE VALUE |
| POST | `/vista/di/rpc/ddr-lock/unlock-node` | DDR LOCK/UNLOCK NODE | SINGLE VALUE |
| GET | `/vista/di/rpc/ddr-find1` | DDR FIND1 | ARRAY |
| GET | `/vista/di/rpc/ddr-get-dd-help` | DDR GET DD HELP | ARRAY |
| GET | `/vista/di/rpc/ddr-finder` | DDR FINDER | GLOBAL ARRAY |
| GET | `/vista/di/rpc/ddr-key-validator` | DDR KEY VALIDATOR | ARRAY |
