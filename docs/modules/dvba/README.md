# Automated Medical Information Exchange (DVBA)
...
**API Endpoint:** `POST /vista/dvba/rpc/dvbab-get-set`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-checklist`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-check-credentials`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-find-exams`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-send-msg`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-appointment-list`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-lists`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-ptinq`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-increase-exam-count`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-health-summary-text`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-2507-pending-report`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-inst-list`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-datetime`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-amis-report`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-sc-veteran-report`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-pending-c&p-report`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-exam-chklist`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-adminq`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-incompvet`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-discharge`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-readmit`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-admissions`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-pending7131`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-cpdetails`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-7131inq`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-lablist`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-version`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-division`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-team-patients`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-reports`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-mail-init`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-surgery-case`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-original-processing-date`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-mpi-assign-icn`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-admission-inquiry`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvbab-report-new-notices-dc`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-template-definition`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-note-titles`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-get-visit-info`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-report-special`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvbab-save-form`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-exams-by-date`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-template-list`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-load-form`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-new-person-file`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-fetch-1u4n`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-template-report-full`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-form-data-backup`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvbab-form-data-backup-delete`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-form-data-backup-restore`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-form-copy`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-find-dups`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvbab-set-division`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-get-url`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-dod-report`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-dod-info`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-find-dfn-by-icn`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-dod-report-types`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-ccow`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-restricted-list-patients`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-zip2city`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-check-patch`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-get-vva-token`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-8861-notifications`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-mvi-search-person`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-mvi-get-corresponding-ids`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbad-contracted-exam-reports`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbad-contracted-exam-crypto`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-send-msg-two`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-exam-xml`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-exam-link-tiu`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-exam-ien`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-getspclconsid`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-listspclconsid`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-setspclconsid`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-listinsufrsn`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-listclaimtype`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-getclaimtype`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-setclaimtype`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-getcancelreason`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-getcontremarks`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-setcontremarks`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-reroute`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-reroute-vamc`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-division`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-div-comment`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-div-exam`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-reroute-code`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-send-reroute`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-reroute-info`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-reroute-status`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-edipi`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-edipi2`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-prf-popup`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-hasflg`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-getflag`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-clrflg`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-self-referral`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-mvi-cerner-correlations`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-active-dbq-list`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-dbq-check`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-dbq-gen-check`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-report-builder`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-dbq-status`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-efolder-token`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-param-inq`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-param-update`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-clindoc-urls`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-toggles`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-par-desc`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-set-metrics`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-purge-met`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-met-rpt`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-all-param`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-capri-allow-clindocs`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-capri-efolder-location`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvbab-capri-provider`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-spec-add`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-spec-status`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-spec-inactive`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-worksheet-stat-list`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-worksheet-name-ed`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-worksheet-status`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-update-dbq-transtat`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-dbq-xml`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-dbq-trans-fail-list`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-save-dbq-xml`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-nf-data`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-exam-report`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-fail-check`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-github-location`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-github-data`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-github-date`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-github-date`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-iepd-data`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-exam-pdf`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-create-worksheet`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-save-exam-pdf`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-worksheet`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-pascal-check`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-worksheet-list`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-delete-check`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-delete-worksheet`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-worksheet-update`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-dbq-pdf`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-invalid-char-list`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-cmt-ssn-var`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-unlock-exam`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-add-exam`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-delete-exam`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-cmt-toggle`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-exam-history`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-exam-restore`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-temp-def-list`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-examiner-info`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-save-signer`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-get-secid`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-uncosign-count`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-uncosigned-info`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-security-toggle`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-pdf-sig-field-names`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-save-review-data`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-trainee-doc-manager`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-trainee-signature`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-status-count`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-alerts-data`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-pdf-logic-toggle`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-worksheet-by-exam`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-pn-toggle`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-skip-parentchild`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-skip-child-reset`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-cmt-iepd-reset`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-cmt-skip-cond`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-word-wrap`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-med-opn-fields`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-support-message`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-nre-load`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-nre-mark`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-nre-open`
...
**API Endpoint:** `POST /vista/dvba/rpc/dvba-capri-nre-save`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-nre-static`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-nre-summary`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-nre-history`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-nre-runnow`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-proxy-data`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-arp-rskdt`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-open-access-check`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-lookup-optset`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-arp-optset`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-toggle-xml-header`
...
**API Endpoint:** `GET /vista/dvba/rpc/dvba-capri-cmt-sigfld-num`
...
| DVBA SITE PARAMETERS | DVBA SUPERVISOR |
| DVBA DISCHARGE RPT | — |
| DVBA NEW REQUEST | DVBA SUPERVISOR |
| DVBA REPORT PENSION/A&A | — |
| DVBA RE-ADMISSION REPORT | — |
| DVBA NOTICE/DISCHARGE PRINT | — |
| DVBA 7132 TASKMAN | — |
| DVBA 7131 NON-ADMITTED VETS | — |
| DVBA MANUAL NOTIFY | — |
...
| DVBA C RELEASE C&P REQUESTS | DVBA C RELEASE 2507 |
...
| DVBA VR BACKGROUND | — |
| DVBA METRICS DATA PURGE | DVBA CAPRI METRICS PURGE |
| DVBA METRICS DATA REPORT | — |
...
| DVBA CAPRI NRE PROCESS TM | — |
| DVBA CAPRI NRE PURGE TM | — |
...
| Name | Security Key |
|------|-------------|
| DVBA REGIONAL OFFICE 7132 MENU | — |
...
- `DVBA SUPERVISOR`
- `DVBA C RELEASE 2507`
- `DVBA CAPRI METRICS PURGE`

## API Route Summary

All routes are prefixed with `/vista/dvba/`.

| Method | Endpoint | RPC | Return Type |
|--------|----------|-----|-------------|
| POST | `/vista/dvba/rpc/dvbab-get-set` | DVBAB GET SET | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-report-checklist` | DVBAB REPORT CHECKLIST | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-check-credentials` | DVBAB CHECK CREDENTIALS | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-find-exams` | DVBAB FIND EXAMS | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-send-msg` | DVBAB SEND MSG | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-appointment-list` | DVBAB APPOINTMENT LIST | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-report-lists` | DVBAB REPORT LISTS | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-ptinq` | DVBAB PTINQ | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-increase-exam-count` | DVBAB INCREASE EXAM COUNT | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-health-summary-text` | DVBAB HEALTH SUMMARY TEXT | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-2507-pending-report` | DVBAB 2507 PENDING REPORT | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-inst-list` | DVBAB INST LIST | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-datetime` | DVBAB DATETIME | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-amis-report` | DVBAB AMIS REPORT | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-sc-veteran-report` | DVBAB SC VETERAN REPORT | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-pending-c&p-report` | DVBAB PENDING C&P REPORT | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-report-exam-chklist` | DVBAB REPORT EXAM CHKLIST | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-report-adminq` | DVBAB REPORT ADMINQ | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-report-incompvet` | DVBAB REPORT INCOMPVET | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-report-discharge` | DVBAB REPORT DISCHARGE | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-report-readmit` | DVBAB REPORT READMIT | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-report-admissions` | DVBAB REPORT ADMISSIONS | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-report-pending7131` | DVBAB REPORT PENDING7131 | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-report-cpdetails` | DVBAB REPORT CPDETAILS | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-report-7131inq` | DVBAB REPORT 7131INQ | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-lablist` | DVBAB LABLIST | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-version` | DVBAB VERSION | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-division` | DVBAB DIVISION | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-team-patients` | DVBAB TEAM PATIENTS | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-reports` | DVBAB REPORTS | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-mail-init` | DVBAB MAIL INIT | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-surgery-case` | DVBAB SURGERY CASE | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-original-processing-date` | DVBAB ORIGINAL PROCESSING DATE | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-mpi-assign-icn` | DVBAB MPI ASSIGN ICN | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-report-admission-inquiry` | DVBAB REPORT ADMISSION INQUIRY | ARRAY |
| POST | `/vista/dvba/rpc/dvbab-report-new-notices-dc` | DVBAB REPORT NEW NOTICES DC | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-template-definition` | DVBAB TEMPLATE DEFINITION | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-note-titles` | DVBAB NOTE TITLES | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-get-visit-info` | DVBAB GET VISIT INFO | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-report-special` | DVBAB REPORT SPECIAL | GLOBAL ARRAY |
| POST | `/vista/dvba/rpc/dvbab-save-form` | DVBAB SAVE FORM | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-exams-by-date` | DVBAB EXAMS BY DATE | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-template-list` | DVBAB TEMPLATE LIST | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-load-form` | DVBAB LOAD FORM | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-new-person-file` | DVBAB NEW PERSON FILE | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-fetch-1u4n` | DVBAB FETCH 1U4N | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-template-report-full` | DVBAB TEMPLATE REPORT FULL | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-form-data-backup` | DVBAB FORM DATA BACKUP | SINGLE VALUE |
| POST | `/vista/dvba/rpc/dvbab-form-data-backup-delete` | DVBAB FORM DATA BACKUP DELETE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-form-data-backup-restore` | DVBAB FORM DATA BACKUP RESTORE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-form-copy` | DVBAB FORM COPY | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-find-dups` | DVBAB FIND DUPS | GLOBAL ARRAY |
| POST | `/vista/dvba/rpc/dvbab-set-division` | DVBAB SET DIVISION | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-get-url` | DVBAB GET URL | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-dod-report` | DVBAB DOD REPORT | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-dod-info` | DVBAB DOD INFO | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-find-dfn-by-icn` | DVBAB FIND DFN BY ICN | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-dod-report-types` | DVBAB DOD REPORT TYPES | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-ccow` | DVBAB CCOW | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-restricted-list-patients` | DVBAB RESTRICTED LIST PATIENTS | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbab-zip2city` | DVBAB ZIP2CITY | ARRAY |
| GET | `/vista/dvba/rpc/dvba-check-patch` | DVBA CHECK PATCH | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-get-vva-token` | DVBAB GET VVA TOKEN | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-8861-notifications` | DVBAB 8861 NOTIFICATIONS | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-mvi-search-person` | DVBA MVI SEARCH PERSON | ARRAY |
| GET | `/vista/dvba/rpc/dvba-mvi-get-corresponding-ids` | DVBA MVI GET CORRESPONDING IDS | ARRAY |
| GET | `/vista/dvba/rpc/dvbad-contracted-exam-reports` | DVBAD CONTRACTED EXAM REPORTS | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvbad-contracted-exam-crypto` | DVBAD CONTRACTED EXAM CRYPTO | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-send-msg-two` | DVBAB SEND MSG TWO | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-exam-xml` | DVBA CAPRI EXAM XML | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-exam-link-tiu` | DVBA CAPRI EXAM LINK TIU | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-exam-ien` | DVBA CAPRI GET EXAM IEN | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-getspclconsid` | DVBA CAPRI GETSPCLCONSID | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-listspclconsid` | DVBA CAPRI LISTSPCLCONSID | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-setspclconsid` | DVBA CAPRI SETSPCLCONSID | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-listinsufrsn` | DVBA CAPRI LISTINSUFRSN | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-listclaimtype` | DVBA CAPRI LISTCLAIMTYPE | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-getclaimtype` | DVBA CAPRI GETCLAIMTYPE | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-setclaimtype` | DVBA CAPRI SETCLAIMTYPE | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-getcancelreason` | DVBA CAPRI GETCANCELREASON | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-getcontremarks` | DVBA CAPRI GETCONTREMARKS | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-setcontremarks` | DVBA CAPRI SETCONTREMARKS | WORD PROCESSING |
| GET | `/vista/dvba/rpc/dvba-capri-get-reroute` | DVBA CAPRI GET REROUTE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-reroute-vamc` | DVBA CAPRI REROUTE VAMC | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-get-division` | DVBA CAPRI GET DIVISION | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-get-div-comment` | DVBA CAPRI GET DIV COMMENT | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-get-div-exam` | DVBA CAPRI GET DIV EXAM | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-get-reroute-code` | DVBA CAPRI GET REROUTE CODE | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-send-reroute` | DVBA CAPRI SEND REROUTE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-reroute-info` | DVBA CAPRI REROUTE INFO | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-reroute-status` | DVBA CAPRI REROUTE STATUS | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-edipi` | DVBA CAPRI GET EDIPI | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-edipi2` | DVBA CAPRI GET EDIPI2 | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-prf-popup` | DVBAB PRF POPUP | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-hasflg` | DVBAB HASFLG | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-getflag` | DVBAB GETFLAG | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-clrflg` | DVBAB CLRFLG | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-self-referral` | DVBAB SELF REFERRAL | ARRAY |
| GET | `/vista/dvba/rpc/dvba-mvi-cerner-correlations` | DVBA MVI CERNER CORRELATIONS | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-active-dbq-list` | DVBA ACTIVE DBQ LIST | ARRAY |
| GET | `/vista/dvba/rpc/dvba-dbq-check` | DVBA DBQ CHECK | ARRAY |
| GET | `/vista/dvba/rpc/dvba-dbq-gen-check` | DVBA DBQ GEN CHECK | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-report-builder` | DVBA REPORT BUILDER | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-dbq-status` | DVBA CAPRI DBQ STATUS | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-efolder-token` | DVBA CAPRI GET EFOLDER TOKEN | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-param-inq` | DVBA CAPRI PARAM INQ | ARRAY |
| POST | `/vista/dvba/rpc/dvba-capri-param-update` | DVBA CAPRI PARAM UPDATE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-clindoc-urls` | DVBA CAPRI CLINDOC URLS | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-get-toggles` | DVBA CAPRI GET TOGGLES | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-par-desc` | DVBA CAPRI GET PAR DESC | ARRAY |
| POST | `/vista/dvba/rpc/dvba-capri-set-metrics` | DVBA CAPRI SET METRICS | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-purge-met` | DVBA CAPRI PURGE MET | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-met-rpt` | DVBA CAPRI GET MET RPT | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-get-all-param` | DVBA CAPRI GET ALL PARAM | ARRAY |
| GET | `/vista/dvba/rpc/dvbab-capri-allow-clindocs` | DVBAB CAPRI ALLOW CLINDOCS | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-capri-efolder-location` | DVBAB CAPRI EFOLDER LOCATION | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvbab-capri-provider` | DVBAB CAPRI PROVIDER | SINGLE VALUE |
| POST | `/vista/dvba/rpc/dvba-capri-spec-add` | DVBA CAPRI SPEC ADD | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-spec-status` | DVBA CAPRI SPEC STATUS | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-spec-inactive` | DVBA CAPRI SPEC INACTIVE | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-worksheet-stat-list` | DVBA CAPRI WORKSHEET STAT LIST | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-worksheet-name-ed` | DVBA CAPRI WORKSHEET NAME ED | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-worksheet-status` | DVBA CAPRI WORKSHEET STATUS | SINGLE VALUE |
| POST | `/vista/dvba/rpc/dvba-capri-update-dbq-transtat` | DVBA CAPRI UPDATE DBQ TRANSTAT | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-dbq-xml` | DVBA CAPRI GET DBQ XML | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-dbq-trans-fail-list` | DVBA CAPRI DBQ TRANS FAIL LIST | GLOBAL ARRAY |
| POST | `/vista/dvba/rpc/dvba-capri-save-dbq-xml` | DVBA CAPRI SAVE DBQ XML | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-nf-data` | DVBA CAPRI NF DATA | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-exam-report` | DVBA CAPRI GET EXAM REPORT | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-fail-check` | DVBA CAPRI FAIL CHECK | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-github-location` | DVBA CAPRI GITHUB LOCATION | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-github-data` | DVBA CAPRI GET GITHUB DATA | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-github-date` | DVBA CAPRI GITHUB DATE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-github-date` | DVBA CAPRI GET GITHUB DATE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-iepd-data` | DVBA CAPRI IEPD DATA | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-exam-pdf` | DVBA CAPRI GET EXAM PDF | GLOBAL ARRAY |
| POST | `/vista/dvba/rpc/dvba-capri-create-worksheet` | DVBA CAPRI CREATE WORKSHEET | ARRAY |
| POST | `/vista/dvba/rpc/dvba-capri-save-exam-pdf` | DVBA CAPRI SAVE EXAM PDF | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-worksheet` | DVBA CAPRI GET WORKSHEET | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-pascal-check` | DVBA CAPRI PASCAL CHECK | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-worksheet-list` | DVBA CAPRI GET WORKSHEET LIST | GLOBAL ARRAY |
| POST | `/vista/dvba/rpc/dvba-capri-delete-check` | DVBA CAPRI DELETE CHECK | SINGLE VALUE |
| POST | `/vista/dvba/rpc/dvba-capri-delete-worksheet` | DVBA CAPRI DELETE WORKSHEET | SINGLE VALUE |
| POST | `/vista/dvba/rpc/dvba-capri-worksheet-update` | DVBA CAPRI WORKSHEET UPDATE | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-get-dbq-pdf` | DVBA CAPRI GET DBQ PDF | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-invalid-char-list` | DVBA CAPRI INVALID CHAR LIST | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-cmt-ssn-var` | DVBA CAPRI CMT SSN VAR | GLOBAL ARRAY |
| POST | `/vista/dvba/rpc/dvba-capri-unlock-exam` | DVBA CAPRI UNLOCK EXAM | SINGLE VALUE |
| POST | `/vista/dvba/rpc/dvba-capri-add-exam` | DVBA CAPRI ADD EXAM | SINGLE VALUE |
| POST | `/vista/dvba/rpc/dvba-capri-delete-exam` | DVBA CAPRI DELETE EXAM | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-cmt-toggle` | DVBA CAPRI CMT TOGGLE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-exam-history` | DVBA CAPRI GET EXAM HISTORY | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-exam-restore` | DVBA CAPRI EXAM RESTORE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-temp-def-list` | DVBA CAPRI TEMP DEF LIST | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-get-examiner-info` | DVBA CAPRI GET EXAMINER INFO | SINGLE VALUE |
| POST | `/vista/dvba/rpc/dvba-capri-save-signer` | DVBA CAPRI SAVE SIGNER | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-get-secid` | DVBA CAPRI GET SECID | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-uncosign-count` | DVBA CAPRI UNCOSIGN COUNT | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-uncosigned-info` | DVBA CAPRI UNCOSIGNED INFO | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-security-toggle` | DVBA CAPRI SECURITY TOGGLE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-pdf-sig-field-names` | DVBA CAPRI PDF SIG FIELD NAMES | GLOBAL ARRAY |
| POST | `/vista/dvba/rpc/dvba-capri-save-review-data` | DVBA CAPRI SAVE REVIEW DATA | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-trainee-doc-manager` | DVBA CAPRI TRAINEE DOC MANAGER | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-trainee-signature` | DVBA CAPRI TRAINEE SIGNATURE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-status-count` | DVBA CAPRI STATUS COUNT | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-alerts-data` | DVBA CAPRI ALERTS DATA | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-pdf-logic-toggle` | DVBA CAPRI PDF LOGIC TOGGLE | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-worksheet-by-exam` | DVBA CAPRI WORKSHEET BY EXAM | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-pn-toggle` | DVBA CAPRI PN TOGGLE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-skip-parentchild` | DVBA CAPRI SKIP PARENTCHILD | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-skip-child-reset` | DVBA CAPRI SKIP CHILD RESET | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-cmt-iepd-reset` | DVBA CAPRI CMT IEPD RESET | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-cmt-skip-cond` | DVBA CAPRI CMT SKIP COND | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-word-wrap` | DVBA CAPRI WORD WRAP | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-med-opn-fields` | DVBA CAPRI MED OPN FIELDS | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-support-message` | DVBA CAPRI SUPPORT MESSAGE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-nre-load` | DVBA CAPRI NRE LOAD | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-nre-mark` | DVBA CAPRI NRE MARK | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-nre-open` | DVBA CAPRI NRE OPEN | GLOBAL ARRAY |
| POST | `/vista/dvba/rpc/dvba-capri-nre-save` | DVBA CAPRI NRE SAVE | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-nre-static` | DVBA CAPRI NRE STATIC | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-nre-summary` | DVBA CAPRI NRE SUMMARY | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-nre-history` | DVBA CAPRI NRE HISTORY | GLOBAL ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-nre-runnow` | DVBA CAPRI NRE RUNNOW | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-proxy-data` | DVBA CAPRI PROXY DATA | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-arp-rskdt` | DVBA CAPRI ARP RSKDT | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-open-access-check` | DVBA CAPRI OPEN ACCESS CHECK | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-lookup-optset` | DVBA CAPRI LOOKUP OPTSET | ARRAY |
| GET | `/vista/dvba/rpc/dvba-capri-arp-optset` | DVBA CAPRI ARP OPTSET | UNKNOWN() |
| GET | `/vista/dvba/rpc/dvba-capri-toggle-xml-header` | DVBA CAPRI TOGGLE XML HEADER | SINGLE VALUE |
| GET | `/vista/dvba/rpc/dvba-capri-cmt-sigfld-num` | DVBA CAPRI CMT SIGFLD NUM | SINGLE VALUE |
