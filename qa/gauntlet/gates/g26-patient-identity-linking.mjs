...
export async function run(_ctx) {
  ...
  if (routeSrc.includes("verificationData = {}")) details.push("Verification data cleared after review");
  ...
  for (const action of ["identity.link_requested", "identity.link_verified", "identity.link_revoked"]) {
