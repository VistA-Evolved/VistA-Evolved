...
export const VISTA_DOWN_DRILL: ResilienceDrill = {
  ...
  expectedRecovery: "API remains alive, readiness degrades, clinical calls return graceful errors, full recovery after VistA restart",
...
export const CIRCUIT_BREAKER_DRILL: ResilienceDrill = {
  ...
  expectedRecovery: "Circuit breaker opens after 5 failures, transitions to half-open after 30s, closes after successful probes",
...
export function getDrillsByCategory(
  category: ResilienceDrill["category"]
): ResilienceDrill[] {
