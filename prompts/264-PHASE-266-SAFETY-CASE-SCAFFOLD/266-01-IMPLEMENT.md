...
1. Create `/docs/safety/SAFETY_CASE.md` — hazards list, controls, test mapping
2. Create `/docs/safety/SAFETY_RELEASE_GATE.md` — minimum gates to deploy
3. Populate evidence directory `evidence/wave-8/P1-safety-case/`
...
- Confirm release smoke suite referenced
...
- evidence/wave-8/P1-safety-case/safety-case.md (new)
