# Phase 726-28 Implement - Performance Slice

## Goal

Browser-audit `/cprs/admin/performance` on the canonical VEHU stack, corroborate the page against the live performance/posture routes, and fix only evidence-backed truth defects.

## Implementation Steps

1. Reconfirm the canonical API is healthy before browser work.
2. Inventory the performance frontend page and backing route files.
3. Authenticate in the browser as `PRO1234 / PRO1234!!`.
4. Open `/cprs/admin/performance` and inspect its tabs, KPIs, charts, and status panels.
