# Phase 726-39 Implement - Exports Slice

## Goal

Browser-audit `/cprs/admin/exports` on the canonical VEHU stack, corroborate the page against the live export and artifact routes it actually uses, and fix only evidence-backed truth defects.

## Implementation Steps

1. Reconfirm the canonical API and VistA connectivity before browser work.
2. Inventory the exports frontend page and the backing route files it calls.
3. Authenticate in the browser as `PRO1234 / PRO1234!!`.
4. Open `/cprs/admin/exports` and inspect each live route-backed section or tab.
