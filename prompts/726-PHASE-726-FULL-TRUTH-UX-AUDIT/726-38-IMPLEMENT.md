# Phase 726-38 Implement - Denial Cases Slice

## Goal

Browser-audit `/cprs/admin/denial-cases` on the canonical VEHU stack, corroborate the page against the live denial-case routes it actually uses, and fix only evidence-backed truth defects.

## Implementation Steps

1. Reconfirm the canonical API and VistA connectivity before browser work.
2. Inventory the denial-cases frontend page and backing route files.
3. Authenticate in the browser as `PRO1234 / PRO1234!!`.
4. Open `/cprs/admin/denial-cases` and inspect each live route-backed section or tab.
