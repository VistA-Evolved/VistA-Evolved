# Phase 726-37 Implement - Coverage Slice

## Goal

Browser-audit `/cprs/admin/coverage` on the canonical VEHU stack, corroborate the page against the live coverage routes it actually uses, and fix only evidence-backed truth defects.

## Implementation Steps

1. Reconfirm the canonical API and VistA connectivity before browser work.
2. Inventory the coverage frontend page and backing route files.
3. Authenticate in the browser as `PRO1234 / PRO1234!!`.
4. Open `/cprs/admin/coverage` and inspect each live route-backed section or tab.
